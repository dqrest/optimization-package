...
*************************************************************************/
void rmatrixsolvels(const real_2d_array &a, const ae_int_t nrows, const ae_int_t ncols, const real_1d_array &b, const long double threshold, ae_int_t &info, densesolverlsreport &rep, real_1d_array &x, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
...
*************************************************************************/
void sparsesolvesymmetricgmres(const sparsematrix &a, const bool isupper, const real_1d_array &b, const ae_int_t k, const long double epsf, const ae_int_t maxits, real_1d_array &x, sparsesolverreport &rep, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 25.09.2021 by Bochkanov Sergey
*************************************************************************/
void sparsesolvegmres(const sparsematrix &a, const real_1d_array &b, const ae_int_t k, const long double epsf, const ae_int_t maxits, real_1d_array &x, sparsesolverreport &rep, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
...
*************************************************************************/
void sparsesolversetcond(const sparsesolverstate &state, const long double epsf, const ae_int_t maxits, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 24.09.2021 by Bochkanov Sergey
*************************************************************************/
void sparsesolveroocgetrequestdata1(const sparsesolverstate &state, long double &v, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
...
value.
  ...
  -- ALGLIB --
     Copyright 14.11.2011 by Bochkanov Sergey
*************************************************************************/
void lincgsetcond(const lincgstate &state, const long double epsf, const ae_int_t maxits, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 30.11.2011 by Bochkanov Sergey
*************************************************************************/
void linlsqrsetlambdai(const linlsqrstate &state, const long double lambdai, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
...
be setted as default values.
  ...
  -- ALGLIB --
     Copyright 30.11.2011 by Bochkanov Sergey
*************************************************************************/
void linlsqrsetcond(const linlsqrstate &state, const long double epsa, const long double epsb, const ae_int_t maxits, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
...
*************************************************************************/
void nleqsetcond(const nleqstate &state, const long double epsf, const ae_int_t maxits, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
...
function value at the x+stp*d.
  ...
  -- ALGLIB --
     Copyright 20.08.2010 by Bochkanov Sergey
*************************************************************************/
void nleqsetstpmax(const nleqstate &state, const long double stpmax, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
...
void nleqsolve(nleqstate &state,
    ...
    void  (*rep)(const real_1d_array &x, long double func, void *ptr), 
    void *ptr,
...
#endif
#if defined(AE_COMPILE_LINCG) || !defined(AE_PARTIAL_BUILD)
static long double lincg_defaultprecision = 1.0E-6;
...
#endif
#if defined(AE_COMPILE_LINLSQR) || !defined(AE_PARTIAL_BUILD)
static long double linlsqr_atol = 1.0E-6;
static long double linlsqr_btol = 1.0E-6;
...
static ae_bool nleq_increaselambda(long double* lambdav,
     long double* nu,
     long double lambdaup,
     ae_state *_state);
static void nleq_decreaselambda(long double* lambdav,
     long double* nu,
     long double lambdadown,
     ae_state *_state);
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_fp_neq(a->ptr.p_double[n],(long double)(0)), "PolynomialSolve: A[N]=0", _state);
     ...
     */
    nz = 0;
    while(nz<n&&ae_fp_eq(a->ptr.p_double[nz],(long double)(0)))
    {
        nz = nz+1;
    }
    ne = n-nz;
    ...
    if( ne>0 )
    {
        ...
        for(i=1; i<=ne-1; i++)
        {
            c.ptr.pp_double[i][i-1] = (long double)(1);
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    ...
    for(i=0; i<=n-1; i++)
    {
        if( ae_fp_eq(a->ptr.pp_double[i][i],(long double)(0)) )
        {
            for(j=0; j<=n-1; j++)
            {
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    ...
    for(i=0; i<=n-1; i++)
    {
        if( ae_fp_eq(lua->ptr.pp_double[i][i],(long double)(0)) )
        {
            for(j=0; j<=n-1; j++)
            {
                b->ptr.p_double[j] = 0.0;
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    ...
    for(i=0; i<=n-1; i++)
    {
        if( ae_c_eq_d(a->ptr.pp_complex[i][i],(long double)(0)) )
        {
            for(j=0; j<=n-1; j++)
            {
                for(k=0; k<=m-1; k++)
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    ...
    for(i=0; i<=n-1; i++)
    {
        if( ae_c_eq_d(lua->ptr.pp_complex[i][i],(long double)(0)) )
        {
            for(j=0; j<=n-1; j++)
            {
                for(k=0; k<=m-1; k++)
    ...
    *info = 0;
    ...
    if( !spdmatrixcholesky(&da, n, isupper, _state) )
    {
        ...
        for(i=0; i<=n-1; i++)
        {
            for(j=0; j<=m-1; j++)
            {
                x->ptr.pp_double[i][j] = (long double)(0);
            }
        }
        rep->r1 = (long double)(0);
        rep->rinf = (long double)(0);
        *info = -3;
        ae_frame_leave(_state);
        return;
    }
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    ...
    if( (nrows<=0||ncols<=0)||ae_fp_less(threshold,(long double)(0)) )
    {
        *info = -1;
        ae_frame_leave(_state);
        return;
    }
    if( ae_fp_eq(threshold,(long double)(0)) )
    {
        threshold = (long double)1000*ae_machineepsilon;
    }
    ...
    zeroa = ae_fp_eq(sv.ptr.p_double[0],(long double)(0));
    if( svdfailed||zeroa )
    {
        if( svdfailed )
        {
        ...
        for(i=0; i<=ncols-1; i++)
        {
            for(j=0; j<=ncols-1; j++)
            {
                if( i==j )
                {
                    rep->cx.ptr.pp_double[i][j] = (long double)(1);
                }
                else
                {
                    rep->cx.ptr.pp_double[i][j] = (long double)(0);
                }
            }
        }
        rep->r2 = (long double)(0);
        ae_frame_leave(_state);
        return;
    }
    ...
    for(rfs=0; rfs<=nrfs; rfs++)
    {
        ...
        else
        {
            ...
            for(i=0; i<=nrows-1; i++)
            {
                ...
                ta.ptr.p_double[ncols] = (long double)(-1);
                ...
                rp.ptr.p_double[i] = -v;
                smallerr = smallerr&&ae_fp_less(ae_fabs(v, _state),(long double)4*verr);
            }
            if( smallerr )
            {
        ...
        for(i=0; i<=ncols-1; i++)
        {
            tmp.ptr.p_double[i] = (long double)(0);
        }
        for(i=0; i<=nsv-1; i++)
        {
            utb.ptr.p_double[i] = (long double)(0);
        }
        for(i=0; i<=nrows-1; i++)
        {
            v = rp.ptr.p_double[i];
        ...
        for(i=0; i<=nsv-1; i++)
        {
            ...
            {
                sutb.ptr.p_double[i] = (long double)(0);
            }
        }
        for(i=0; i<=nsv-1; i++)
        {
        ...
        for(k=0; k<=m-1; k++)
        {
            ...
            for(rfs=0; rfs<=nrfs-1; rfs++)
            {
                ...
                for(i=0; i<=n-1; i++)
                {
                    ...
                    xa.ptr.p_double[n] = (long double)(-1);
        ...
        if( havea )
        {
            ...
            for(rfs=0; rfs<=nrfs-1; rfs++)
            {
                ...
                for(i=0; i<=n-1; i++)
                {
                    ...
                    smallerr = smallerr&&ae_fp_less(ae_c_abs(v, _state),(long double)4*verr);
                }
                if( smallerr )
                {
                    terminatenexttime = ae_true;
     ...
     ae_state *_state)
{
    ...
    result = directdensesolvers_densesolverrfsmax(n, (long double)(0), (long double)(0), _state);
    return result;
}
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_isfinite(epsf, _state)&&ae_fp_greater_eq(epsf,(long double)(0)), "SparseSolveSymmetricGMRES: EpsF<0 or infinite", _state);
    ae_assert(maxits>=0, "SparseSolveSymmetricGMRES: MaxIts<0", _state);
    if( ae_fp_eq(epsf,(long double)(0))&&maxits==0 )
    {
        epsf = 1.0E-6;
    }
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_isfinite(epsf, _state)&&ae_fp_greater_eq(epsf,(long double)(0)), "SparseSolveGMRES: EpsF<0 or infinite", _state);
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_isfinite(epsf, _state)&&ae_fp_greater_eq(epsf,(long double)(0)), "SparseSolverSetCond: EpsF is negative or contains infinite or NaN values", _state);
     ...
     ae_state *_state)
{
    ...
    if( ae_fp_neq(rdotv2(state->n, &state->x0, _state),(long double)(0)) )
    {
        goto lbl_7;
    }
...
lbl_9:
lbl_11:
    if( !(ae_fp_greater(res,(long double)(0))&&(state->maxits==0||state->repiterationscount<state->maxits)) )
    {
        goto lbl_12;
    }
...
lbl_15:
    ...
    if( ae_fp_greater_eq(res,prevres*((long double)1-ae_sqrt(ae_machineepsilon, _state))) )
    {
...
void lincgcreate(ae_int_t n, lincgstate* state, ae_state *_state)
{
    ...
    for(i=0; i<=state->n-1; i++)
    {
        ...
        state->b.ptr.p_double[i] = (long double)(0);
    }
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_isfinite(epsf, _state)&&ae_fp_greater_eq(epsf,(long double)(0)), "LinCGSetCond: EpsF is negative or contains infinite or NaN values", _state);
...
lbl_0:
    ...
    bnorm = (long double)(0);
    state->r2 = (long double)(0);
    state->meritfunction = (long double)(0);
    for(i=0; i<=state->n-1; i++)
    {
        ...
        state->meritfunction = state->meritfunction+state->mv.ptr.p_double[i]*state->rx.ptr.p_double[i]-(long double)2*state->b.ptr.p_double[i]*state->rx.ptr.p_double[i];
...
lbl_3:
    state->needvmv = ae_false;
    if( !ae_isfinite(state->vmv, _state)||ae_fp_less_eq(state->vmv,(long double)(0)) )
    {
...
lbl_4:
    ...
    for(i=0; i<=state->n-1; i++)
    {
        v = v+state->mv.ptr.p_double[i]*state->cx.ptr.p_double[i]-(long double)2*state->b.ptr.p_double[i]*state->cx.ptr.p_double[i];
    }
...
lbl_7:
    ...
    if( state->repiterationscount%state->itsbeforerestart!=0 )
    {
         ...
         */
        if( !ae_isfinite(uvar, _state)||ae_fp_eq(uvar,(long double)(0)) )
        {
            state->running = ae_false;
            state->repterminationtype = -4;
            result = ae_false;
     ...
     ae_state *_state)
{
    ...
    if( state->prectype==0 )
    {
        ...
        for(i=0; i<=n-1; i++)
        {
            ...
            if( ae_fp_greater(v,(long double)(0)) )
            {
                state->tmpd.ptr.p_double[i] = (long double)1/ae_sqrt(v, _state);
            }
            else
            {
                state->tmpd.ptr.p_double[i] = (long double)(1);
            }
        }
    }
    else
     ...
     ae_state *_state)
{
    ...
    state->epsc = (long double)1/ae_sqrt(ae_machineepsilon, _state);
    state->maxits = 0;
    state->lambdai = (long double)(0);
    state->xrep = ae_false;
    state->running = ae_false;
    state->repiterationscount = 0;
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_isfinite(lambdai, _state)&&ae_fp_greater_eq(lambdai,(long double)(0)), "LinLSQRSetLambdaI: LambdaI is infinite or NaN", _state);
...
lbl_8:
    ...
    for(i=0; i<=state->n-1; i++)
    {
        state->rx.ptr.p_double[i] = (long double)(0);
    }
...
lbl_13:
     ...
     */
    state->betai = bnorm;
    if( ae_fp_eq(state->betai,(long double)(0)) )
    {
    ...
    for(i=0; i<=summn-1; i++)
    {
        ...
        {
            state->ui.ptr.p_double[i] = (long double)(0);
        }
...
lbl_3:
    ...
    for(i=0; i<=state->n-1; i++)
    {
        state->d.ptr.p_double[i] = (long double)(0);
    }
    state->dnorm = (long double)(0);
...
lbl_4:
    ...
    if( ae_fp_neq(state->betaip1,(long double)(0)) )
    {
...
lbl_5:
    ...
    if( ae_fp_neq(state->alphaip1,(long double)(0)) )
    {
    ...
    for(i=0; i<=state->n-1; i++)
    {
        state->d.ptr.p_double[i] = (long double)1/state->rhoi*(state->vi.ptr.p_double[i]-state->theta*state->d.ptr.p_double[i]);
     ...
     ae_state *_state)
{
    ...
    if( state->prectype==0 )
    {
        ...
        for(i=0; i<=n-1; i++)
        {
            state->tmpd.ptr.p_double[i] = (long double)(0);
        }
        t0 = 0;
        t1 = 0;
        ...
        for(i=0; i<=n-1; i++)
        {
            if( ae_fp_greater(state->tmpd.ptr.p_double[i],(long double)(0)) )
            {
                state->tmpd.ptr.p_double[i] = (long double)1/ae_sqrt(state->tmpd.ptr.p_double[i], _state);
            }
            else
            {
                state->tmpd.ptr.p_double[i] = (long double)(1);
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_isfinite(epsa, _state)&&ae_fp_greater_eq(epsa,(long double)(0)), "LinLSQRSetCond: EpsA is negative, INF or NAN", _state);
    ae_assert(ae_isfinite(epsb, _state)&&ae_fp_greater_eq(epsb,(long double)(0)), "LinLSQRSetCond: EpsB is negative, INF or NAN", _state);
    ae_assert(maxits>=0, "LinLSQRSetCond: MaxIts is negative", _state);
    if( (ae_fp_eq(epsa,(long double)(0))&&ae_fp_eq(epsb,(long double)(0)))&&maxits==0 )
    {
        state->epsa = linlsqr_atol;
        state->epsb = linlsqr_btol;
     ...
     ae_state *_state)
{
    ...
    state->n = n;
    state->m = m;
    nleqsetcond(state, (long double)(0), 0, _state);
    nleqsetxrep(state, ae_false, _state);
    nleqsetstpmax(state, (long double)(0), _state);
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_fp_greater_eq(epsf,(long double)(0)), "NLEQSetCond: negative EpsF!", _state);
...
function value at the x+stp*d.
  ...
  -- ALGLIB --
     Copyright 20.08.2010 by Bochkanov Sergey
*************************************************************************/
void nleqsetstpmax(nleqstate* state, long double stpmax, ae_state *_state)
{


    ae_assert(ae_isfinite(stpmax, _state), "NLEQSetStpMax: StpMax is not finite!", _state);
    ae_assert(ae_fp_greater_eq(stpmax,(long double)(0)), "NLEQSetStpMax: StpMax<0!", _state);
    state->stpmax = stpmax;
}
...
lbl_9:
    ...
    for(i=0; i<=n-1; i++)
    {
        state->candstep.ptr.p_double[i] = (long double)(0);
    }
     ...
     */
    stepnorm = (long double)(0);
    for(i=0; i<=n-1; i++)
    {
        if( ae_fp_neq(state->candstep.ptr.p_double[i],(long double)(0)) )
        {
            stepnorm = (long double)(1);
            break;
        }
    }
    linminnormalized(&state->candstep, &stepnorm, n, _state);
    if( ae_fp_neq(state->stpmax,(long double)(0)) )
    {
...
lbl_11:
    ...
    if( ae_fp_eq(stepnorm,(long double)(0))&&state->repterminationtype==0 )
    {
        state->repterminationtype = -4;
    }
    if( state->repiterationscount>=state->maxits&&state->maxits>0 )
...
static ae_bool nleq_increaselambda(long double* lambdav,
     ...
     ae_state *_state)
{
    long double lnlambda;
    long double lnnu;
    long double lnlambdaup;
    long double lnmax;
    ae_bool result;
    ...
    if( ae_fp_greater(lnnu+ae_log((long double)(2), _state),lnmax) )
    {
        return result;
    }
