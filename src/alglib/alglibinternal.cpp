...
static void xblas_xsum(/* Real    */ ae_vector* w,
     ...
     long double* rerr,
     ae_state *_state);
static long double xblas_xfastpow(long double r, ae_int_t n, ae_state *_state);


#endif
#if defined(AE_COMPILE_LINMIN) || !defined(AE_PARTIAL_BUILD)
static long double linmin_ftol = 0.001;
static long double linmin_xtol = (long double)100*ae_machineepsilon;
static ae_int_t linmin_maxfev = 20;
static long double linmin_stpmin = 1.0E-50;
static long double linmin_defstpmax = 1.0E+50;
static long double linmin_armijofactor = 1.3;
static void linmin_mcstep(long double* stx,
     long double* fx,
     long double* dx,
     long double* sty,
     long double* fy,
...
static long double ftbase_ftbaseinefficiencyfactor = 1.3;
...
variables).
  ...
  -- ALGLIB --
     Copyright 17.09.2012 by Bochkanov Sergey
*************************************************************************/
void touchreal(long double* a, ae_state *_state)
{
...
*************************************************************************/
long double coalesce(long double a, long double b, ae_state *_state)
{
    long double result;
...
The function convert integer value to real value.
  ...
  -- ALGLIB --
     Copyright 17.09.2012 by Bochkanov Sergey
*************************************************************************/
long double inttoreal(ae_int_t a, ae_state *_state)
{
    long double result;
...
NOTE: it costs twice as much as Ln(x)
  ...
  -- ALGLIB --
     Copyright 17.09.2012 by Bochkanov Sergey
*************************************************************************/
long double logbase2(long double x, ae_state *_state)
{
    long double result;


    result = ae_log(x, _state)/ae_log((long double)(2), _state);
    return result;
}
...
*************************************************************************/
ae_bool approxequal(long double a, long double b, long double tol, ae_state *_state)
{
    ae_bool result;
...
to errors as large as max(|a|,|b|)*tol.
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
ae_bool approxequalrel(long double a, long double b, long double tol, ae_state *_state)
{
    ae_bool result;
...
If N=1 then suborutine generates only one point at the middle of [A,B]
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
void taskgenint1d(long double a,
     long double b,
     ae_int_t n,
     /* Real    */ ae_vector* x,
     /* Real    */ ae_vector* y,
     ae_state *_state)
{
    ...
    {
        x->ptr.p_double[0] = a;
        y->ptr.p_double[0] = (long double)2*ae_randomreal(_state)-(long double)1;
        h = (b-a)/(long double)(n-1);
        for(i=1; i<=n-1; i++)
        {
            if( i!=n-1 )
            {
                x->ptr.p_double[i] = a+((long double)i+0.2*((long double)2*ae_randomreal(_state)-(long double)1))*h;
            }
            else
            {
                x->ptr.p_double[i] = b;
            }
            y->ptr.p_double[i] = y->ptr.p_double[i-1]+((long double)2*ae_randomreal(_state)-(long double)1)*(x->ptr.p_double[i]-x->ptr.p_double[i-1]);
        }
    }
    else
    {
...
If N=1 then suborutine generates only one point at the middle of [A,B]
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
void taskgenint1dequidist(long double a,
     long double b,
     ae_int_t n,
     /* Real    */ ae_vector* x,
     /* Real    */ ae_vector* y,
     ae_state *_state)
{
    ...
    if( n>1 )
    {
        ...
        for(i=1; i<=n-1; i++)
        {
            x->ptr.p_double[i] = a+(long double)i*h;
            y->ptr.p_double[i] = y->ptr.p_double[i-1]+((long double)2*ae_randomreal(_state)-(long double)1)*h;
        }
    }
    else
    {
...
If N=1 then suborutine generates only one point at the middle of [A,B]
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
void taskgenint1dcheb1(long double a,
     long double b,
     ae_int_t n,
     /* Real    */ ae_vector* x,
     /* Real    */ ae_vector* y,
     ae_state *_state)
{
    ...
    if( n>1 )
    {
        for(i=0; i<=n-1; i++)
        {
            x->ptr.p_double[i] = 0.5*(b+a)+0.5*(b-a)*ae_cos(ae_pi*(long double)(2*i+1)/(long double)(2*n), _state);
            if( i==0 )
            {
                y->ptr.p_double[i] = (long double)2*ae_randomreal(_state)-(long double)1;
            }
            else
            {
                y->ptr.p_double[i] = y->ptr.p_double[i-1]+((long double)2*ae_randomreal(_state)-(long double)1)*(x->ptr.p_double[i]-x->ptr.p_double[i-1]);
...
If N=1 then suborutine generates only one point at the middle of [A,B]
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
void taskgenint1dcheb2(long double a,
     long double b,
     ae_int_t n,
     /* Real    */ ae_vector* x,
     /* Real    */ ae_vector* y,
     ae_state *_state)
{
    ...
    if( n>1 )
    {
        for(i=0; i<=n-1; i++)
        {
            x->ptr.p_double[i] = 0.5*(b+a)+0.5*(b-a)*ae_cos(ae_pi*(long double)i/(long double)(n-1), _state);
            if( i==0 )
            {
                y->ptr.p_double[i] = (long double)2*ae_randomreal(_state)-(long double)1;
            }
     ...
     ae_state *_state)
{
    ...
    for(i=1; i<=n-1; i++)
    {
        if( ae_fp_eq((x->ptr.p_double[i]-a)/(b-a)+(long double)1,(x->ptr.p_double[i-1]-a)/(b-a)+(long double)1) )
        {
            result = ae_false;
            return result;
        }
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=n-1; i++)
    {
        x->ptr.p_double[i] = (long double)(0);
    }
}
     ...
     ae_state *_state)
{
     ...
     * Choose new size
     */
    n = ae_maxint(n, ae_round(1.8*(long double)x->cnt+(long double)1, _state), _state);
     ...
     ae_state *_state)
{
    ...
    if( a->rows<n )
    {
        n = ae_maxint(n, ae_round(1.8*(long double)a->rows+(long double)1, _state), _state);
    }
     ...
     ae_state *_state)
{
    ...
    if( a->cols<n )
    {
        n = ae_maxint(n, ae_round(1.8*(long double)a->cols+(long double)1, _state), _state);
    }
...
*************************************************************************/
long double safepythag2(long double x, long double y, ae_state *_state)
{
    long double w;
    long double xabs;
    long double yabs;
    ...
    if( ae_fp_eq(z,(long double)(0)) )
    {
        result = w;
    }
    else
    {
        result = w*ae_sqrt((long double)1+ae_sqr(z/w, _state), _state);
    }
    return result;
}
...
Safe sqrt(x^2+y^2)
  ...
  -- ALGLIB --
     Copyright by Bochkanov Sergey
*************************************************************************/
long double safepythag3(long double x, long double y, long double z, ae_state *_state)
{
    long double w;
    long double result;
...
No overflow is generated in any case.
  ...
  -- ALGLIB --
     Copyright by Bochkanov Sergey
*************************************************************************/
ae_int_t saferdiv(long double x, long double y, long double* r, ae_state *_state)
{
    ae_int_t result;
    ...
    *r = 0.0;
     ...
     * * X=0 and Y<>0
     */
    if( ae_fp_eq(y,(long double)(0)) )
    {
        result = 1;
        if( ae_fp_eq(x,(long double)(0)) )
        {
            *r = _state->v_nan;
        }
        if( ae_fp_greater(x,(long double)(0)) )
        {
            *r = _state->v_posinf;
        }
        if( ae_fp_less(x,(long double)(0)) )
        {
            *r = _state->v_neginf;
        }
        return result;
     ...
     *
     */
    if( ae_fp_greater_eq(y,(long double)(1)) )
    {
        *r = x/y;
...
No overflow is generated in any case.
  ...
  -- ALGLIB --
     Copyright by Bochkanov Sergey
*************************************************************************/
long double safeminposrv(long double x, long double y, long double v, ae_state *_state)
{
    long double r;
    long double result;
...
* T replaces X
  ...
  -- ALGLIB --
     Copyright by Bochkanov Sergey
*************************************************************************/
void apperiodicmap(long double* x,
     long double a,
     long double b,
     long double* k,
     ae_state *_state)
{
    ...
    *k = (long double)(ae_ifloor((*x-a)/(b-a), _state));
    *x = *x-*k*(b-a);
...
Returns random normal number using low-quality system-provided generator
  ...
  -- ALGLIB --
     Copyright 20.03.2009 by Bochkanov Sergey
*************************************************************************/
long double randomnormal(ae_state *_state)
{
    long double u;
    long double v;
    long double s;
    ...
    for(;;)
    {
        u = (long double)2*ae_randomreal(_state)-(long double)1;
        v = (long double)2*ae_randomreal(_state)-(long double)1;
        s = ae_sqr(u, _state)+ae_sqr(v, _state);
        if( ae_fp_greater(s,(long double)(0))&&ae_fp_less(s,(long double)(1)) )
        {
             ...
             */
            s = ae_sqrt(-(long double)2*ae_log(s, _state), _state)/ae_sqrt(s, _state);
            result = u*s;
            break;
        }
    }
...
void randomunit(ae_int_t n, /* Real    */ ae_vector* x, ae_state *_state)
{
    ...
    while(ae_fp_less_eq(v,(long double)(0)));
    v = (long double)1/ae_sqrt(v, _state);
    for(i=0; i<=n-1; i++)
    {
...
*************************************************************************/
void swapr(long double* v0, long double* v1, ae_state *_state)
{
    long double v;
...
*************************************************************************/
long double maxreal3(long double v0, long double v1, long double v2, ae_state *_state)
{
    long double result;
...
*************************************************************************/
long double possign(long double x, ae_state *_state)
{
    long double result;


    if( ae_fp_greater_eq(x,(long double)(0)) )
    {
...
*************************************************************************/
long double rmul2(long double v0, long double v1, ae_state *_state)
{
    long double result;
...
*************************************************************************/
long double rmul3(long double v0, long double v1, long double v2, ae_state *_state)
{
    long double result;
...
*************************************************************************/
long double rmul4(long double v0, long double v1, long double v2, long double v3, ae_state *_state)
{
    long double result;
...
*************************************************************************/
long double rmax3(long double r0, long double r1, long double r2, ae_state *_state)
{
    long double result;
...
This function returns max(|r0|,|r1|,|r2|)
*************************************************************************/
long double rmaxabs3(long double r0, long double r1, long double r2, ae_state *_state)
{
    long double result;
...
'bounds' value: maps X to [B1,B2]
  ...
  -- ALGLIB --
     Copyright 20.03.2009 by Bochkanov Sergey
*************************************************************************/
long double boundval(long double x, long double b1, long double b2, ae_state *_state)
{
    long double result;
...
'bounds' value: maps X to [B1,B2]
  ...
  -- ALGLIB --
     Copyright 20.03.2009 by Bochkanov Sergey
*************************************************************************/
long double rboundval(long double x, long double b1, long double b2, ae_state *_state)
{
    long double result;
...
*************************************************************************/
long double rcase2(ae_bool cond, long double v0, long double v1, ae_state *_state)
{
    long double result;
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=n-1; i++)
    {
        if( !(v->ptr.p_double[i]==(long double)0) )
        {
            result = result+1;
        }
    }
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=m-1; i++)
    {
        for(j=0; j<=n-1; j++)
        {
            if( !(v->ptr.pp_double[i][j]==(long double)0) )
            {
                result = result+1;
            }
        }
...
functionality.
  ...
  -- ALGLIB routine --
     ...
     Bochkanov Sergey
*************************************************************************/
long double sparselevel2density(ae_state *_state)
{
    long double result;
...
*************************************************************************/
long double smpactivationlevel(ae_state *_state)
{
    long double nn;
    long double result;


    nn = (long double)(2*matrixtilesizeb(_state));
    result = ae_maxreal(0.95*(long double)2*nn*nn*nn, 1.0E7, _state);
    return result;
}
...
It returns real number in order to avoid overflow problems.
  ...
  -- ALGLIB --
     Copyright 10.01.2018 by Bochkanov Sergey
*************************************************************************/
long double spawnlevel(ae_state *_state)
{
    long double nn;
    long double result;


    nn = (long double)(2*matrixtilesizea(_state));
    result = 0.95*(long double)2*nn*nn*nn;
    return result;
}
     ...
     ae_state *_state)
{
    ...
    for(j=j0; j<=j1-1; j++)
    {
        ...
        {
            ae_trace("%14.6e",
                (long double)(a->ptr.pp_double[i][j]));
        }
        if( prectouse==1 )
        {
            ae_trace("%23.15e",
...
*************************************************************************/
long double minspeedup(ae_state *_state)
{
    long double result;
...
*************************************************************************/
void savgcounterinit(savgcounter* c, long double priorvalue, ae_state *_state)
{


    c->rsum = (long double)(0);
    c->rcnt = (long double)(0);
    c->prior = priorvalue;
}
...
*************************************************************************/
void savgcounterenqueue(savgcounter* c, long double v, ae_state *_state)
{


    c->rsum = c->rsum+v;
    c->rcnt = c->rcnt+(long double)1;
}
...
Enqueue value into SAvgCounter
*************************************************************************/
long double savgcounterget(savgcounter* c, ae_state *_state)
{
    long double result;


    if( ae_fp_eq(c->rcnt,(long double)(0)) )
    {
        result = c->prior;
    }
    else
...
void igrowv(ae_int_t newn, /* Integer */ ae_vector* x, ae_state *_state)
{
    ...
    oldn = x->cnt;
    newn = ae_maxint(newn, ae_round(1.8*(long double)oldn+(long double)1, _state), _state);
    ae_swap_vectors(x, &oldx);
     ...
     ae_state *_state)
{
     ...
     */
    if( k==0||ae_c_eq_d(alpha,(long double)(0)) )
    {
        if( ae_c_neq_d(beta,(long double)(1)) )
        {
            if( ae_c_neq_d(beta,(long double)(0)) )
            {
                for(i=0; i<=m-1; i++)
                {
                    for(j=0; j<=n-1; j++)
    ...
    while(i<m)
    {
        ...
        while(j<n)
        {
            ...
            if( i+2<=m&&j+2<=n )
            {
                ...
                v11.x = v11x;
                v11.y = v11y;
                if( ae_c_eq_d(beta,(long double)(0)) )
                {
     ...
     ae_state *_state)
{
     ...
     * if K=0 or Alpha=0, then C=Beta*C
     */
    if( k==0||ae_fp_eq(alpha,(long double)(0)) )
    {
        if( ae_fp_neq(beta,(long double)(1)) )
        {
            if( ae_fp_neq(beta,(long double)(0)) )
            {
                for(i=0; i<=m-1; i++)
            ...
            else
            {
                for(i=0; i<=m-1; i++)
                {
                    for(j=0; j<=n-1; j++)
                    {
                        c->ptr.pp_double[ic+i][jc+j] = (long double)(0);
                    }
                }
            }
        }
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_fp_neq(alpha,(long double)(0)), "RMatrixGEMMK44V00: internal error (Alpha=0)", _state);
    ...
    while(i<m)
    {
        ...
        while(j<n)
        {
            ...
            if( i+4<=m&&j+4<=n )
            {
                ...
                if( ae_fp_eq(beta,(long double)(0)) )
                {
     ...
     ae_state *_state)
{
    ...
    s = (long double)(1);
    if( ae_fp_neq(mx,(long double)(0)) )
    {
        if( ae_fp_less(mx,(long double)(1)) )
        {
            s = ae_sqrt(ae_minrealnumber, _state);
            v = ae_complex_from_d((long double)1/s);
    ...
    alphr = alpha.x;
    alphi = alpha.y;
    if( ae_fp_eq(xnorm,(long double)(0))&&ae_fp_eq(alphi,(long double)(0)) )
    {
        *tau = ae_complex_from_i(0);
    ...
    if( ae_fp_less(alphr,(long double)(0)) )
    {
        beta = -beta;
    }
    tau->x = (beta-alphr)/beta;
    tau->y = -alphi/beta;
    alpha = ae_c_d_div((long double)(1),ae_c_sub_d(alpha,beta));
    if( n>1 )
    {
     ...
     ae_state *_state)
{
    ...
    if( (ae_c_eq_d(tau,(long double)(0))||n1>n2)||m1>m2 )
    {
        return;
    }
...
long double vectornorm2(/* Real    */ ae_vector* x,
     ae_int_t i1,
     ae_int_t i2,
     ae_state *_state)
{
    ...
    for(ix=i1; ix<=i2; ix++)
    {
        if( ae_fp_neq(x->ptr.p_double[ix],(long double)(0)) )
        {
            absxi = ae_fabs(x->ptr.p_double[ix], _state);
            if( ae_fp_less(scl,absxi) )
            {
                ssq = (long double)1+ssq*ae_sqr(scl/absxi, _state);
                scl = absxi;
            }
            else
            {
...
long double upperhessenberg1norm(/* Real    */ ae_matrix* a,
     ae_int_t i1,
     ae_int_t i2,
     ae_int_t j1,
     ae_int_t j2,
     ...
     ae_state *_state)
{
    ...
    for(j=j1; j<=j2; j++)
    {
        work->ptr.p_double[j] = (long double)(0);
    }
    for(i=i1; i<=i2; i++)
    {
     ...
     ae_state *_state)
{
    ...
    if( !trans )
    {
        ...
        if( ae_fp_eq(beta,(long double)(0)) )
        {
            for(i=iy1; i<=iy2; i++)
            {
                y->ptr.p_double[i] = (long double)(0);
            }
        }
        else
        {
...
long double pythag2(long double x, long double y, ae_state *_state)
{
    long double w;
    long double xabs;
    long double yabs;
     ...
     ae_state *_state)
{
    ...
    work->ptr.p_double[1] = (long double)(0);
    work->ptr.p_double[i] = (long double)(0);
    ...
    if( ae_fp_eq(beta,(long double)(0)) )
    {
        for(i=ci1; i<=ci2; i++)
        {
            for(j=cj1; j<=cj2; j++)
            {
                c->ptr.pp_double[i][j] = (long double)(0);
            }
        }
    }
    else
    ...
    if( isforward )
    {
        if( n1!=n2 )
        {
            ...
            for(j=m1; j<=m2-1; j++)
            {
                ...
                if( ae_fp_neq(ctemp,(long double)(1))||ae_fp_neq(stemp,(long double)(0)) )
                {
                    jp1 = j+1;
...
CS**2 + SN**2 = 1
*************************************************************************/
void generaterotation(long double f,
     long double g,
     long double* cs,
     long double* sn,
     long double* r,
    ...
    *r = 0.0;
    ...
    else
    {
        ...
        else
        {
            ...
            {
                *r = ae_fabs(f1, _state)*ae_sqrt((long double)1+ae_sqr(g1/f1, _state), _state);
            }
            else
            {
                *r = ae_fabs(g1, _state)*ae_sqrt((long double)1+ae_sqr(f1/g1, _state), _state);
            }
            *cs = f1/(*r);
            *sn = g1/(*r);
            if( ae_fp_greater(ae_fabs(f, _state),ae_fabs(g, _state))&&ae_fp_less(*cs,(long double)(0)) )
            {
                *cs = -*cs;
                *sn = -*sn;
                *r = -*r;
     ...
     ae_state *_state)
{
    ...
    if( n==1 )
    {
        x->ptr.p_double[0] = (long double)(0);
        return;
    }
    if( buf->ra1.cnt<n )
    {
    ...
    if( ae_fp_eq(buf->ra1.ptr.p_double[0],buf->ra1.ptr.p_double[n-1]) )
    {
        ...
        {
            tmp = (long double)(n-1)/(long double)2;
        }
        for(i=0; i<=n-1; i++)
        {
    ...
    while(i<=n-1)
    {
        ...
        for(k=i; k<=j-1; k++)
        {
            buf->ra1.ptr.p_double[k] = (long double)(i+j-1)/(long double)2;
        }
        i = j;
    }
    ...
    if( iscentered )
    {
        voffs = (long double)(n-1)/(long double)2;
    }
    else
    {
        voffs = 0.0;
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=n-1; i++)
    {
        x->ptr.p_double[buf->ia1.ptr.p_int[i]] = (long double)(i);
    }
}
     ...
     ae_state *_state)
{
    ...
    *s = 0.0;
     ...
     */
    smlnum = ae_minrealnumber/(ae_machineepsilon*(long double)2);
    bignum = (long double)1/smlnum;
    *s = (long double)(1);
    if( !normin )
    {
        ...
        else
        {
            ...
            cnorm->ptr.p_double[n] = (long double)(0);
        }
    }
    ...
    {
        tscal = (long double)1/(smlnum*tmax);
    ...
    if( notran )
    {
        ...
        if( ae_fp_neq(tscal,(long double)(1)) )
        {
            grow = (long double)(0);
        }
        else
        {
            if( nounit )
            {
                 ...
                 */
                grow = (long double)1/ae_maxreal(xbnd, smlnum, _state);
                xbnd = grow;
                j = jfirst;
                while((jinc>0&&j<=jlast)||(jinc<0&&j>=jlast))
                {
                    ...
                    xbnd = ae_minreal(xbnd, ae_minreal((long double)(1), tjj, _state)*grow, _state);
            ...
            else
            {
                 ...
                 */
                grow = ae_minreal((long double)(1), (long double)1/ae_maxreal(xbnd, smlnum, _state), _state);
                j = jfirst;
                while((jinc>0&&j<=jlast)||(jinc<0&&j>=jlast))
                {
                     ...
                     * G(j) = G(j-1)*( 1 + CNORM(j) )
                     */
                    grow = grow*((long double)1/((long double)1+cnorm->ptr.p_double[j]));
                    j = j+jinc;
                }
            }
        }
        ...
        else
        {
            if( nounit )
            {
                ...
                while((jinc>0&&j<=jlast)||(jinc<0&&j>=jlast))
                {
                     ...
                     */
                    xj = (long double)1+cnorm->ptr.p_double[j];
    ...
    else
    {
        ...
        if( notran )
        {
            ...
            while((jinc>0&&j<=jlast)||(jinc<0&&j>=jlast))
            {
                ...
                {
                    tjjs = tscal;
                    if( ae_fp_eq(tscal,(long double)(1)) )
                    {
                        flg = 100;
                    }
                }
                if( flg!=100 )
                {
                    ...
                    if( ae_fp_greater(tjj,smlnum) )
                    {
                         ...
                         * abs(A(j,j)) > SMLNUM:
                         */
                        if( ae_fp_less(tjj,(long double)(1)) )
                        {
                    ...
                    {
                        if( ae_fp_greater(tjj,(long double)(0)) )
                        {
                            ...
                            if( ae_fp_greater(xj,tjj*bignum) )
                            {
                                 ...
                                 */
                                rec = tjj*bignum/xj;
                                if( ae_fp_greater(cnorm->ptr.p_double[j],(long double)(1)) )
                                {
                        ...
                        else
                        {
                            ...
                            x->ptr.p_double[j] = (long double)(1);
                            xj = (long double)(1);
                            *s = (long double)(0);
                            xmax = (long double)(0);
                        }
                 ...
                 */
                if( ae_fp_greater(xj,(long double)(1)) )
                {
                    rec = (long double)1/xj;
        ...
        else
        {
            ...
            while((jinc>0&&j<=jlast)||(jinc<0&&j>=jlast))
            {
                ...
                xj = ae_fabs(x->ptr.p_double[j], _state);
                uscal = tscal;
                rec = (long double)1/ae_maxreal(xmax, (long double)(1), _state);
                if( ae_fp_greater(cnorm->ptr.p_double[j],(bignum-xj)*rec) )
                {
                    ...
                    tjj = ae_fabs(tjjs, _state);
                    if( ae_fp_greater(tjj,(long double)(1)) )
                    {
                        
                        /*
                         * Divide by A(j,j) when scaling x if A(j,j) > 1.
                         */
                        rec = ae_minreal((long double)(1), rec*tjj, _state);
                        uscal = uscal/tjjs;
                    }
                    if( ae_fp_less(rec,(long double)(1)) )
                    {
                        ae_v_muld(&x->ptr.p_double[1], 1, ae_v_len(1,n), rec);
                        *s = *s*rec;
                        xmax = xmax*rec;
                ...
                sumj = (long double)(0);
                if( ae_fp_eq(uscal,(long double)(1)) )
                {
     ...
     ae_state *_state)
{
    ...
    result = ae_false;
    if( ae_c_eq_d(alpha,(long double)(0)) )
    {
        return result;
    }
    if( ae_c_neq_d(beta,(long double)(0)) )
...
OUTPUT PARAMETERS
    ...
    RErr    -   estimate of error. This estimate accounts for both  errors
                ...
                rounding of A and B to fit in long double (about 1 ulp).
     ...
     ae_state *_state)
{
    ...
    *rerr = 0.0;
     ...
     * total error
     */
    if( ae_fp_eq(rerrx,(long double)(0))&&ae_fp_eq(rerry,(long double)(0)) )
    {
        *rerr = (long double)(0);
    }
    else
    {
        *rerr = ae_maxreal(rerrx, rerry, _state)*ae_sqrt((long double)1+ae_sqr(ae_minreal(rerrx, rerry, _state)/ae_maxreal(rerrx, rerry, _state), _state), _state);
    }
}
     ...
     ae_state *_state)
{
    ...
    *rerr = 0.0;
     ...
     * Prepare
     */
    ln2 = ae_log((long double)(2), _state);
    *rerr = mx*ae_machineepsilon;
    ...
    s = xblas_xfastpow((long double)(2), -k, _state);
    ...
    while(ae_fp_greater_eq(s*mx,(long double)(1)))
    {
        s = 0.5*s;
    }
     ...
     */
    k = ae_trunc(ae_log((long double)536870912/(long double)n, _state)/ln2, _state);
    chunk = xblas_xfastpow((long double)(2), k, _state);
    if( ae_fp_less(chunk,(long double)(2)) )
    {
        chunk = (long double)(2);
    }
    invchunk = (long double)1/chunk;
    ...
    *r = (long double)(0);
    ...
    for(;;)
    {
        ...
        for(i=0; i<=n-1; i++)
        {
            v = w->ptr.p_double[i];
            k = ae_trunc(v, _state);
            if( ae_fp_neq(v,(long double)(k)) )
            {
                allzeros = ae_false;
            }
            w->ptr.p_double[i] = chunk*(v-(long double)k);
            ks = ks+k;
        }
        *r = *r+s*(long double)ks;
        if( allzeros||ae_fp_eq(s*(long double)n+mx,mx) )
        {
            break;
        }
    }
...
static long double xblas_xfastpow(long double r, ae_int_t n, ae_state *_state)
{
    ...
    if( n<0 )
    {
        result = xblas_xfastpow((long double)1/r, -n, _state);
    }
    return result;
}
     ...
     ae_state *_state)
{
    ...
    *stp = *stp/s;
    ...
    s = (long double)1/ae_sqrt(s, _state);
    ae_v_muld(&d->ptr.p_double[0], 1, ae_v_len(0,n-1), s);
    *stp = *stp/s;
}
     ...
     ae_state *_state)
{
    ...
    state->xtrapf = 4.0;
    zero = (long double)(0);
    if( ae_fp_eq(stpmax,(long double)(0)) )
    {
    ...
    for(;;)
    {
        ...
        if( *stage==2 )
        {
            ...
            *info = 0;
             ...
             */
            if( ae_fp_less(stpmax,linmin_stpmin)&&ae_fp_greater(stpmax,(long double)(0)) )
            {
                *info = 5;
                *stp = stpmax;
                *stage = 0;
            ...
            if( ((((((n<=0||ae_fp_less_eq(*stp,(long double)(0)))||ae_fp_less(linmin_ftol,(long double)(0)))||ae_fp_less(gtol,zero))||ae_fp_less(linmin_xtol,zero))||ae_fp_less(linmin_stpmin,zero))||ae_fp_less(stpmax,linmin_stpmin))||linmin_maxfev<=0 )
            {
                *stage = 0;
                return;
            }
            ...
            state->dginit = v;
            if( ae_fp_greater_eq(state->dginit,(long double)(0)) )
            {
                *stage = 0;
                *stp = (long double)(0);
                return;
            ...
            *nfev = 0;
             ...
             */
            state->stx = (long double)(0);
            state->fx = state->finit;
            state->dgx = state->dginit;
            state->sty = (long double)(0);
...
ae_bool armijoiteration(armijostate* state, ae_state *_state)
{
     ...
     * Routine body
     */
    if( (ae_fp_less_eq(state->stplen,(long double)(0))||ae_fp_less(state->stpmax,(long double)(0)))||state->fmax<2 )
    {
        state->info = 0;
        result = ae_false;
        return result;
     ...
     * Bound StpLen
     */
    if( ae_fp_greater(state->stplen,state->stpmax)&&ae_fp_neq(state->stpmax,(long double)(0)) )
    {
    ...
    if( ae_fp_greater(v,state->stpmax)&&ae_fp_neq(state->stpmax,(long double)(0)) )
    {
        v = state->stpmax;
    }
     ...
     ae_state *_state)
{
    ...
    *info = 0;
     ...
     *     CHECK THE INPUT PARAMETERS FOR ERRORS.
     */
    if( ((*brackt&&(ae_fp_less_eq(*stp,ae_minreal(*stx, *sty, _state))||ae_fp_greater_eq(*stp,ae_maxreal(*stx, *sty, _state))))||ae_fp_greater_eq(*dx*(*stp-(*stx)),(long double)(0)))||ae_fp_less(stmax,stmin) )
    {
        return;
    }
    ...
    if( ae_fp_greater(fp,*fx) )
    {
        *info = 1;
        bound = ae_true;
        theta = (long double)3*(*fx-fp)/(*stp-(*stx))+(*dx)+dp;
        ...
        r = p/q;
        stpc = *stx+r*(*stp-(*stx));
        stpq = *stx+*dx/((*fx-fp)/(*stp-(*stx))+(*dx))/(long double)2*(*stp-(*stx));
        ...
        {
            stpf = stpc+(stpq-stpc)/(long double)2;
        }
        *brackt = ae_true;
    }
    else
    {
        if( ae_fp_less(sgnd,(long double)(0)) )
        {
        ...
        else
        {
            if( ae_fp_less(ae_fabs(dp, _state),ae_fabs(*dx, _state)) )
            {
                ...
                *info = 3;
                 ...
                 */
                gamma = s*ae_sqrt(ae_maxreal((long double)(0), ae_sqr(theta/s, _state)-*dx/s*(dp/s), _state), _state);
                if( ae_fp_greater(*stp,*stx) )
                {
                    gamma = -gamma;
                }
                ...
                q = gamma+(*dx-dp)+gamma;
                r = p/q;
                if( ae_fp_less(r,(long double)(0))&&ae_fp_neq(gamma,(long double)(0)) )
                {
                    stpc = *stp+r*(*stx-(*stp));
                }
                else
            ...
            else
            {
                ...
                *info = 4;
                ...
                if( *brackt )
                {
                    theta = (long double)3*(fp-(*fy))/(*sty-(*stp))+(*dy)+dp;
...
long double nulog1p(long double x, ae_state *_state)
{
    long double z;
    long double lp;
    long double lq;
...
long double nuexpm1(long double x, ae_state *_state)
{
    long double r;
    long double xx;
    long double ep;
...
long double nucosm1(long double x, ae_state *_state)
{
    long double xx;
    long double c;
    long double result;
    ...
    {
        result = ae_cos(x, _state)-(long double)1;
        return result;
    }
    xx = x*x;
     ...
     ae_state *_state)
{
    ...
    if( ae_fp_eq(ra*rb,(long double)(a*b)) )
    {
        result = a*b%n;
        return result;
    }
...
N should be power of 2, estimates are badly wrong for non-power-of-2 N's.
  ...
  -- ALGLIB --
     Copyright 01.05.2009 by Bochkanov Sergey
*************************************************************************/
long double ftbasegetflopestimate(ae_int_t n, ae_state *_state)
{
    long double result;


    result = ftbase_ftbaseinefficiencyfactor*((long double)(4*n)*ae_log((long double)(n), _state)/ae_log((long double)(2), _state)-(long double)(6*n)+(long double)8);
    return result;
}
    ...
    for(opidx=0; opidx<=operandscnt-1; opidx++)
    {
        for(i=0; i<=n-1; i++)
        {
            ...
            for(k=0; k<=n-1; k++)
            {
                ...
                c = ae_cos(-(long double)2*ae_pi*(long double)k*(long double)i/(long double)n, _state);
                s = ae_sin(-(long double)2*ae_pi*(long double)k*(long double)i/(long double)n, _state);
                hre = hre+c*re-s*im;
                him = him+c*im+s*re;
            }
     ...
     ae_state *_state)
{
    ...
    if( n==3 )
    {
        c1 = ae_cos((long double)2*ae_pi/(long double)3, _state)-(long double)1;
        c2 = ae_sin((long double)2*ae_pi/(long double)3, _state);
        for(opidx=0; opidx<=operandscnt-1; opidx++)
        {
            aoffset = offs+opidx*operandsize*2;
            a0x = a->ptr.p_double[aoffset+0];
    ...
    if( n==5 )
    {
        v = (long double)2*ae_pi/(long double)5;
        c1 = (ae_cos(v, _state)+ae_cos((long double)2*v, _state))/(long double)2-(long double)1;
        c2 = (ae_cos(v, _state)-ae_cos((long double)2*v, _state))/(long double)2;
        c3 = -ae_sin(v, _state);
        c4 = -(ae_sin(v, _state)+ae_sin((long double)2*v, _state));
        c5 = ae_sin(v, _state)-ae_sin((long double)2*v, _state);
        for(opidx=0; opidx<=operandscnt-1; opidx++)
        {
            aoffset = offs+opidx*operandsize*2;
    ...
    if( n==6 )
    {
        c1 = ae_cos((long double)2*ae_pi/(long double)3, _state)-(long double)1;
        c2 = ae_sin((long double)2*ae_pi/(long double)3, _state);
        c3 = ae_cos(-ae_pi/(long double)3, _state);
        c4 = ae_sin(-ae_pi/(long double)3, _state);
        for(opidx=0; opidx<=operandscnt-1; opidx++)
        {
            aoffset = offs+opidx*operandsize*2;
            a0x = a->ptr.p_double[aoffset+0];
     ...
     ae_state *_state)
{
    ...
    if( n==2 )
    {
        v = -(long double)2*ae_pi/(long double)(n*m);
        tw0 = -(long double)2*ae_sqr(ae_sin(0.5*v, _state), _state);
        tw1 = ae_sin(v, _state);
        for(opidx=0; opidx<=operandscnt-1; opidx++)
        {
            ...
            for(mvidx=0; mvidx<=m-1; mvidx++)
            {
                ...
                a->ptr.p_double[aoffset2] = v2*((long double)1+twxm1)-v3*twy;
                a->ptr.p_double[aoffset2+1] = v3*((long double)1+twxm1)+v2*twy;
                aoffset0 = aoffset0+2;
                aoffset2 = aoffset2+2;
                if( (mvidx+1)%ftbase_updatetw==0 )
                {
                    v = -(long double)2*ae_pi*(long double)(mvidx+1)/(long double)(n*m);
                    twxm1 = ae_sin(0.5*v, _state);
                    twxm1 = -(long double)2*twxm1*twxm1;
                    twy = ae_sin(v, _state);
                }
                else
                {
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=2*m-1; i++)
    {
        precr->ptr.p_double[offs+i] = (long double)(0);
    }
    for(i=0; i<=n-1; i++)
    {
        bx = ae_cos(ae_pi/(long double)n*(long double)i*(long double)i, _state);
        by = ae_sin(ae_pi/(long double)n*(long double)i*(long double)i, _state);
     ...
     ae_state *_state)
{
    ...
    for(op=0; op<=operandscnt-1; op++)
    {
        ...
        for(i=2*n; i<=2*m-1; i++)
        {
            bufa->ptr.p_double[i] = (long double)(0);
        }
        ...
        for(i=0; i<=n-1; i++)
        {
            ...
            rx = bufa->ptr.p_double[p1+0]/(long double)m;
            ry = -bufa->ptr.p_double[p1+1]/(long double)m;
     ...
     ae_state *_state)
{
    ...
    for(q=0; q<=n-2; q++)
    {
        v = -(long double)2*ae_pi*(long double)kiq/(long double)n;
     ...
     ae_state *_state)
{
    ...
    for(opidx=0; opidx<=operandscnt-1; opidx++)
    {
        ...
        for(i=0; i<=n-2; i++)
        {
            a->ptr.p_double[p0+0] = a->ptr.p_double[p0+0]/(long double)(n-1);
            a->ptr.p_double[p0+1] = -a->ptr.p_double[p0+1]/(long double)(n-1);
            p0 = p0+2;
        }
     ...
     ae_state *_state)
{
    ...
    *n2 = 0;
    ...
    if( n>ftbase_recursivethreshold )
    {
        k = ae_iceil(ae_sqrt((long double)(n), _state), _state)+1;
...
static ae_int_t ftbase_ftoptimisticestimate(ae_int_t n, ae_state *_state)
{
    ...
    result = ae_ifloor(1.0E-5*(long double)5*(long double)n*ae_log((long double)(n), _state)/ae_log((long double)(2), _state), _state);
    return result;
}
     ...
     ae_state *_state)
{
    ...
    long double twxm1;
    long double twy;
    long double twbasexm1;
    long double twbasey;
    long double twrowxm1;
    long double twrowy;
    long double tmpx;
    long double tmpy;
    long double v;
    ...
    halfn1 = n1/2;
    n = n1*n2;
    v = -(long double)2*ae_pi/(long double)n;
    twbasexm1 = -(long double)2*ae_sqr(ae_sin(0.5*v, _state), _state);
    twbasey = ae_sin(v, _state);
    twrowxm1 = (long double)(0);
    twrowy = (long double)(0);
    offs = aoffset;
    for(i=0; i<=n2-1; i++)
    {
        ...
        for(j2=0; j2<=halfn1-1; j2++)
        {
            ...
            tmpx = x*((long double)1+twxm1)-y*twy;
            tmpy = x*twy+y*((long double)1+twxm1);
            a->ptr.p_double[offs+0] = tmpx;
            a->ptr.p_double[offs+1] = tmpy;
            tmpx = ((long double)1+twxm1)*twrowxm1-twy*twrowy;
            twy = twy+((long double)1+twxm1)*twrowy+twy*twrowxm1;
            twxm1 = twxm1+tmpx;
            ...
            if( (j2+1)%updatetw2==0&&j2<halfn1-1 )
            {
                 ...
                 */
                v = -(long double)2*ae_pi*(long double)i*(long double)2*(long double)(j2+1)/(long double)n;
                twxm1 = ae_sin(0.5*v, _state);
                twxm1 = -(long double)2*twxm1*twxm1;
                twy = ae_sin(v, _state);
            }
        ...
        if( i<n2-1 )
        {
            ...
            {
                v = -(long double)2*ae_pi*(long double)(i+1)/(long double)n;
                twrowxm1 = ae_sin(0.5*v, _state);
                twrowxm1 = -(long double)2*twrowxm1*twrowxm1;
