...
typedef struct { long double x, y; } ae_complex;
...
typedef struct ae_state
{
    ...
    /*
     * long double value for NAN
     */
    long double v_nan;
    
    /*
     * long double value for +INF
     */
    long double v_posinf;
    
    /*
     * long double value for -INF
     */
    long double v_neginf;
...
/*
extern const long double ae_machineepsilon;
extern const long double ae_maxrealnumber;
extern const long double ae_minrealnumber;
extern const long double ae_pi;
*/
...
public:
    complex();
    complex(const long double &_x);
    complex(const long double &_x, const long double &_y);
    complex(const complex &z);
    complex(const alglib_impl::ae_complex &z):x(z.x),y(z.y){};

    complex& operator= (const long double& v);
    complex& operator+=(const long double& v);
    complex& operator-=(const long double& v);
    complex& operator*=(const long double& v);
    complex& operator/=(const long double& v);
...
const alglib::complex operator-(const alglib::complex& lhs);
const alglib::complex operator+(const alglib::complex& lhs, const alglib::complex& rhs);
const alglib::complex operator+(const alglib::complex& lhs, const long double& rhs);
const alglib::complex operator+(const long double& lhs, const alglib::complex& rhs);
const alglib::complex operator-(const alglib::complex& lhs, const alglib::complex& rhs);
const alglib::complex operator-(const alglib::complex& lhs, const long double& rhs);
const alglib::complex operator-(const long double& lhs, const alglib::complex& rhs);
const alglib::complex operator*(const alglib::complex& lhs, const alglib::complex& rhs);
...
const alglib::complex operator/(const long double& lhs, const alglib::complex& rhs);
const alglib::complex operator/(const alglib::complex& lhs, const long double& rhs);
long double abscomplex(const alglib::complex &z);
...
********************************************************************/
long double vdotproduct(const long double *v0, ae_int_t stride0, const long double *v1, ae_int_t stride1, ae_int_t n);
long double vdotproduct(const long double *v1, const long double *v2, ae_int_t N);
...
void vmove(long double *vdst,  ae_int_t stride_dst, const long double* vsrc,  ae_int_t stride_src, ae_int_t n);
void vmove(long double *vdst, const long double* vsrc, ae_int_t N);
...
void vmoveneg(long double *vdst,  ae_int_t stride_dst, const long double* vsrc,  ae_int_t stride_src, ae_int_t n);
void vmoveneg(long double *vdst, const long double *vsrc, ae_int_t N);
...
void vmove(long double *vdst,  ae_int_t stride_dst, const long double* vsrc,  ae_int_t stride_src, ae_int_t n, long double alpha);
void vmove(long double *vdst, const long double *vsrc, ae_int_t N, long double alpha);

void vmove(alglib::complex *vdst, ae_int_t stride_dst, const alglib::complex* vsrc, ae_int_t stride_src, const char *conj_src, ae_int_t n, long double alpha);
void vmove(alglib::complex *vdst, const alglib::complex *vsrc, ae_int_t N, long double alpha);
...
void vadd(long double *vdst,  ae_int_t stride_dst, const long double *vsrc,  ae_int_t stride_src, ae_int_t n);
void vadd(long double *vdst, const long double *vsrc, ae_int_t N);
...
void vadd(long double *vdst,  ae_int_t stride_dst, const long double *vsrc,  ae_int_t stride_src, ae_int_t n, long double alpha);
void vadd(long double *vdst, const long double *vsrc, ae_int_t N, long double alpha);

void vadd(alglib::complex *vdst, ae_int_t stride_dst, const alglib::complex *vsrc, ae_int_t stride_src, const char *conj_src, ae_int_t n, long double alpha);
void vadd(alglib::complex *vdst, const alglib::complex *vsrc, ae_int_t N, long double alpha);
...
void vsub(long double *vdst,  ae_int_t stride_dst, const long double *vsrc,  ae_int_t stride_src, ae_int_t n);
void vsub(long double *vdst, const long double *vsrc, ae_int_t N);
...
void vsub(long double *vdst,  ae_int_t stride_dst, const long double *vsrc,  ae_int_t stride_src, ae_int_t n, long double alpha);
void vsub(long double *vdst, const long double *vsrc, ae_int_t N, long double alpha);

void vsub(alglib::complex *vdst, ae_int_t stride_dst, const alglib::complex *vsrc, ae_int_t stride_src, const char *conj_src, ae_int_t n, long double alpha);
void vsub(alglib::complex *vdst, const alglib::complex *vsrc, ae_int_t N, long double alpha);
...
void vmul(long double *vdst,  ae_int_t stride_dst, ae_int_t n, long double alpha);
void vmul(long double *vdst, ae_int_t N, long double alpha);

void vmul(alglib::complex *vdst, ae_int_t stride_dst, ae_int_t n, long double alpha);
void vmul(alglib::complex *vdst, ae_int_t N, long double alpha);
...
public:
    ...
    const long double& operator()(ae_int_t i) const;
    long double& operator()(ae_int_t i);
    ...
    // copy of data is created.
    //
    void setcontent(ae_int_t iLen, const long double *pContent);
    ...
    //
    void attach_to_ptr(ae_int_t iLen, long double *pContent);
    
    //
    // This function returns pointer to internal memory
    //
    long double* getcontent();
    const long double* getcontent() const;
...
public:
    ...
    const long double& operator()(ae_int_t i, ae_int_t j) const;
    long double& operator()(ae_int_t i, ae_int_t j);
    ...
    // copy of data is created.
    //
    void setcontent(ae_int_t irows, ae_int_t icols, const long double *pContent);
    ...
    // it is not allowed to resize it (no setlength() calls).
    //
    void attach_to_ptr(ae_int_t irows, ae_int_t icols, long double *pContent);
...
This function reads CSV  file  and  stores  its  contents  to  long double
...
* escaped fields (ones in long double quotes) are not supported
...
********************************************************************/
extern const long double machineepsilon;
extern const long double maxrealnumber;
extern const long double minrealnumber;
extern const long double fp_nan;
extern const long double fp_posinf;
extern const long double fp_neginf;
extern const ae_int_t endianness;
static const int CSV_DEFAULT = 0x0;
static const int CSV_SKIP_HEADERS = 0x1;

int sign(long double x);
long double randomreal();
ae_int_t randominteger(ae_int_t maxv);
int round(long double x);
int trunc(long double x);
int ifloor(long double x);
int iceil(long double x);
long double pi();
long double sqr(long double x);
int maxint(int m1, int m2);
int minint(int m1, int m2);
long double maxreal(long double m1, long double m2);
long double minreal(long double m1, long double m2);

bool fp_eq(long double v1, long double v2);
bool fp_neq(long double v1, long double v2);
bool fp_less(long double v1, long double v2);
bool fp_less_eq(long double v1, long double v2);
bool fp_greater(long double v1, long double v2);
bool fp_greater_eq(long double v1, long double v2);

bool fp_isnan(long double x);
bool fp_isposinf(long double x);
bool fp_isneginf(long double x);
bool fp_isinf(long double x);
bool fp_isfinite(long double x);
...
ae_bool _ialglib_i_rmatrixgerf(ae_int_t m,
    ...
    #if defined(_ALGLIB_HAS_AVX2_INTRINSICS) || defined(_ALGLIB_HAS_FMA_INTRINSICS)
        #define ULOAD256PD(x) _mm256_loadu_pd((const long double*)(&x))
    #endif
#endif
...
long double rmaxr(ae_int_t n,
     ...
     ae_int_t rowidx,
     ae_state *_state);
long double rmaxabsv(ae_int_t n,
     /* Real    */ ae_vector* x,
     ae_state *_state);
