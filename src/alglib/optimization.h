...
typedef struct
{
    ...
    ae_int_t n;
    ae_int_t resetfreq;
    long double stpshort;
    long double gammasml;
    long double reg;
    long double smallreg;
    long double microreg;
    ae_int_t m;
    ae_matrix hcurrent;
    ae_int_t hage;
    long double sumy2;
...
typedef struct
{
    ...
    long double lagprobstepmax;
    ae_int_t lagprobnstepsstored;
    ae_vector lagprobxs;
    ae_vector lagprobd;
    long double lagprobstp;
    ae_vector lagprobx;
    ae_vector lagprobfi;
    long double lagprobrawlag;
    ae_matrix lagprobj;
    ...
    long double nonc0currentrating;
    long double nonc1currentrating;
    ae_bool badgradhasxj;
    optguardreport rep;
    long double nonc0strrating;
    long double nonc0lngrating;
    optguardnonc0report nonc0strrep;
    optguardnonc0report nonc0lngrep;
    long double nonc1test0strrating;
    long double nonc1test0lngrating;
    optguardnonc1test0report nonc1test0strrep;
    optguardnonc1test0report nonc1test0lngrep;
    long double nonc1test1strrating;
    long double nonc1test1lngrating;
...
typedef struct
{
    ...
    ae_int_t nec;
    ae_int_t nic;
    long double lastgoodstep;
    long double lastscaledgoodstep;
    long double maxscaledgrad;
    ae_vector hasbndl;
    ae_vector hasbndu;
    ae_vector bndl;
    ae_vector bndu;
    ...
    ae_int_t repvaridx;
    ae_int_t repterminationtype;
    long double repdebugeqerr;
    long double repdebugfs;
    long double repdebugff;
    long double repdebugdx;
    ...
    ae_int_t mcstage;
    long double stp;
    long double curstpmax;
    long double activationstep;
    ae_vector work;
    linminstate lstate;
    long double trimthreshold;
...
typedef struct
{
    ...
    ae_vector tmp0;
    ae_vector tmpct;
    long double actualdecrease;
    long double predicteddecrease;
    minqpstate qpstate;
    minqpreport qprep;
    sparsematrix tmpsp;
} minlmstepfinder;
...
typedef struct
{
    ...
    ae_int_t repiterationscount;
    ae_int_t repterminationtype;
    long double repbcerr;
    ae_int_t repbcidx;
    long double replcerr;
    ae_int_t replcidx;
    long double repnlcerr;
    ae_int_t repnlcidx;
    rcommstate rstate;
} minsqpstate;
#endif
...
typedef struct
{
    long double pivottol;
    long double perturbmag;
    ae_int_t maxtrfage;
    ae_int_t trftype;
    ae_int_t ratiotest;
    ae_int_t pricing;
...
typedef struct
{
    ...
    long double repfillpivotrow;
    ae_int_t repfillpivotrowcnt;
    long double repfillrhor;
    ae_int_t repfillrhorcnt;
    long double repfilldensemu;
...
typedef struct
{
    ...
    ae_vector cs;
    long double repf;
    long double repprimalerror;
    long double repdualerror;
    long double repslackerror;
    ae_int_t repiterationscount;
    ae_int_t repterminationtype;
    ae_int_t repn;
    ae_int_t repm;
...
typedef struct
{
    ...
    ae_vector y;
    ae_vector stats;
    long double primalerror;
    long double dualerror;
    long double slackerror;
    ae_int_t iterationscount;
    ae_int_t terminationtype;
} minlpreport;
#endif
...
typedef struct
{
    ...
    long double lastlcerr;
    ae_int_t lastlcidx;
    long double lastnlcerr;
    ae_int_t lastnlcidx;
    ae_vector tmp0;
    ae_vector d;
    linminstate mcstate;
...
typedef struct
{
    long double stabilizingpoint;
    long double initialinequalitymultiplier;
    ae_int_t solvertype;
    ae_int_t prectype;
    ae_int_t updatefreq;
    long double rho;
...
typedef struct
{
    ...
    hqrndstate agsrs;
    long double agsradius;
    ae_int_t agssamplesize;
    long double agsraddecay;
    long double agsalphadecay;
    long double agsdecrease;
    long double agsinitstp;
    long double agsstattold;
    long double agsshortstpabs;
    long double agsshortstprel;
    long double agsshortf;
    ae_int_t agsshortlimit;
    long double agsrhononlinear;
    ae_int_t agsminupdate;
    ae_int_t agsmaxraddecays;
    ae_int_t agsmaxbacktrack;
    ae_int_t agsmaxbacktracknonfull;
    long double agspenaltylevel;
    long double agspenaltyincrease;
    ae_vector xstart;
    ae_vector xc;
    ae_vector xn;
    ae_vector rawg;
...
*************************************************************************/
void minlbfgscreatef(const ae_int_t n, const ae_int_t m, const real_1d_array &x, const long double diffstep, minlbfgsstate &state, const xparams _xparams = alglib::xdefault);
void minlbfgscreatef(const ae_int_t m, const real_1d_array &x, const long double diffstep, minlbfgsstate &state, const xparams _xparams = alglib::xdefault);
...
automatic stopping criterion selection (small EpsX).
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
void minlbfgssetcond(const minlbfgsstate &state, const long double epsg, const long double epsf, const long double epsx, const ae_int_t maxits, const xparams _xparams = alglib::xdefault);
...
overflow) without actually calculating function value at the x+stp*d.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
void minlbfgssetstpmax(const minlbfgsstate &state, const long double stpmax, const xparams _xparams = alglib::xdefault);
...
void minlbfgsoptimize(minlbfgsstate &state,
    void (*func)(const real_1d_array &x, long double &func, void *ptr),
    void  (*rep)(const real_1d_array &x, long double func, void *ptr) = NULL,
    void *ptr = NULL,
    const xparams _xparams = alglib::xdefault);
void minlbfgsoptimize(minlbfgsstate &state,
    void (*grad)(const real_1d_array &x, long double &func, real_1d_array &grad, void *ptr),
    void  (*rep)(const real_1d_array &x, long double func, void *ptr) = NULL,
    void *ptr = NULL,
    const xparams _xparams = alglib::xdefault);
...
*************************************************************************/
void minlbfgsoptguardgradient(const minlbfgsstate &state, const long double teststep, const xparams _xparams = alglib::xdefault);
...
4. Numerical  differentiation  is   very   inefficient  -   one   gradient
  ...
  -- ALGLIB --
     Copyright 16.05.2011 by Bochkanov Sergey
*************************************************************************/
void minbleiccreatef(const ae_int_t n, const real_1d_array &x, const long double diffstep, minbleicstate &state, const xparams _xparams = alglib::xdefault);
void minbleiccreatef(const real_1d_array &x, const long double diffstep, minbleicstate &state, const xparams _xparams = alglib::xdefault);
...
NOTE: when SetCond() called with non-zero MaxIts, BLEIC solver may perform
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
void minbleicsetcond(const minbleicstate &state, const long double epsg, const long double epsf, const long double epsx, const ae_int_t maxits, const xparams _xparams = alglib::xdefault);
...
overflow) without actually calculating function value at the x+stp*d.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
void minbleicsetstpmax(const minbleicstate &state, const long double stpmax, const xparams _xparams = alglib::xdefault);
...
In order to verify gradient algorithm performs following steps:
  ...
  * we  build  cubic  model using function values and derivatives at trial
  ...
  -- ALGLIB --
     Copyright 15.06.2014 by Bochkanov Sergey
*************************************************************************/
void minbleicoptguardgradient(const minbleicstate &state, const long double teststep, const xparams _xparams = alglib::xdefault);
...
length, but it may change in the future versions of ALGLIB).
  ...
  -- ALGLIB --
     Copyright 11.01.2011 by Bochkanov Sergey
*************************************************************************/
void minqpsetalgobleic(const minqpstate &state, const long double epsg, const long double epsf, const long double epsx, const ae_int_t maxits, const xparams _xparams = alglib::xdefault);
...
*************************************************************************/
void minqpsetalgodenseaul(const minqpstate &state, const long double epsx, const long double rho, const ae_int_t itscnt, const xparams _xparams = alglib::xdefault);
...
*************************************************************************/
void minqpsetalgodenseipm(const minqpstate &state, const long double eps, const xparams _xparams = alglib::xdefault);
...
>
  ...
  -- ALGLIB --
     Copyright 01.11.2019 by Bochkanov Sergey
*************************************************************************/
void minqpsetalgosparseipm(const minqpstate &state, const long double eps, const xparams _xparams = alglib::xdefault);
...
*************************************************************************/
void minqpsetalgoquickqp(const minqpstate &state, const long double epsg, const long double epsf, const long double epsx, const ae_int_t maxouterits, const bool usenewton, const xparams _xparams = alglib::xdefault);
...
NOTE: infinite values can be specified by means of long double.PositiveInfinity
      and  long double.NegativeInfinity  (in  C#)  and  alglib::fp_posinf   and
...
NOTE: BndL>BndU will result in QP problem being recognized as infeasible.
  ...
  -- ALGLIB --
     Copyright 11.01.2011 by Bochkanov Sergey
*************************************************************************/
void minqpsetbcall(const minqpstate &state, const long double bndl, const long double bndu, const xparams _xparams = alglib::xdefault);
...
NOTE: BndL>BndU will result in QP problem being recognized as infeasible.
  ...
  -- ALGLIB --
     Copyright 11.01.2011 by Bochkanov Sergey
*************************************************************************/
void minqpsetbci(const minqpstate &state, const ae_int_t i, const long double bndl, const long double bndu, const xparams _xparams = alglib::xdefault);
...
*************************************************************************/
void minqpaddlc2dense(const minqpstate &state, const real_1d_array &a, const long double al, const long double au, const xparams _xparams = alglib::xdefault);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 19.07.2018 by Bochkanov Sergey
*************************************************************************/
void minqpaddlc2(const minqpstate &state, const integer_1d_array &idxa, const real_1d_array &vala, const ae_int_t nnz, const long double al, const long double au, const xparams _xparams = alglib::xdefault);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 19.07.2018 by Bochkanov Sergey
*************************************************************************/
void minqpaddlc2sparsefromdense(const minqpstate &state, const real_1d_array &da, const long double al, const long double au, const xparams _xparams = alglib::xdefault);
...
2. if target function contains exp() or other fast growing functions,  and
  ...
  -- ALGLIB --
     Copyright 30.03.2009 by Bochkanov Sergey
*************************************************************************/
void minlmcreatev(const ae_int_t n, const ae_int_t m, const real_1d_array &x, const long double diffstep, minlmstate &state, const xparams _xparams = alglib::xdefault);
void minlmcreatev(const ae_int_t m, const real_1d_array &x, const long double diffstep, minlmstate &state, const xparams _xparams = alglib::xdefault);
...
NOTE: it is not recommended to set large EpsX (say, 0.001). Because LM  is
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
void minlmsetcond(const minlmstate &state, const long double epsx, const ae_int_t maxits, const xparams _xparams = alglib::xdefault);
...
with limits on step size.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
void minlmsetstpmax(const minlmstate &state, const long double stpmax, const xparams _xparams = alglib::xdefault);
...
void minlmoptimize(minlmstate &state,
    void (*func)(const real_1d_array &x, long double &func, void *ptr),
    void (*grad)(const real_1d_array &x, long double &func, real_1d_array &grad, void *ptr),
    void (*hess)(const real_1d_array &x, long double &func, real_1d_array &grad, real_2d_array &hess, void *ptr),
    void  (*rep)(const real_1d_array &x, long double func, void *ptr) = NULL,
    void *ptr = NULL,
    const xparams _xparams = alglib::xdefault);
void minlmoptimize(minlmstate &state,
...
In order to verify gradient algorithm performs following steps:
  ...
  * we  build  cubic  model using function values and derivatives at trial
  ...
  -- ALGLIB --
     Copyright 15.06.2014 by Bochkanov Sergey
*************************************************************************/
void minlmoptguardgradient(const minlmstate &state, const long double teststep, const xparams _xparams = alglib::xdefault);
...
4. Numerical  differentiation  is   very   inefficient  -   one   gradient
  ...
  -- ALGLIB --
     Copyright 16.05.2011 by Bochkanov Sergey
*************************************************************************/
void mincgcreatef(const ae_int_t n, const real_1d_array &x, const long double diffstep, mincgstate &state, const xparams _xparams = alglib::xdefault);
void mincgcreatef(const real_1d_array &x, const long double diffstep, mincgstate &state, const xparams _xparams = alglib::xdefault);
...
automatic stopping criterion selection (small EpsX).
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
void mincgsetcond(const mincgstate &state, const long double epsg, const long double epsf, const long double epsx, const ae_int_t maxits, const xparams _xparams = alglib::xdefault);
...
overflow) without actually calculating function value at the x+stp*d.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
void mincgsetstpmax(const mincgstate &state, const long double stpmax, const xparams _xparams = alglib::xdefault);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 30.07.2010 by Bochkanov Sergey
*************************************************************************/
void mincgsuggeststep(const mincgstate &state, const long double stp, const xparams _xparams = alglib::xdefault);
...
In order to verify gradient algorithm performs following steps:
  ...
  * we  build  cubic  model using function values and derivatives at trial
  ...
  -- ALGLIB --
     Copyright 15.06.2014 by Bochkanov Sergey
*************************************************************************/
void mincgoptguardgradient(const mincgstate &state, const long double teststep, const xparams _xparams = alglib::xdefault);
...
*************************************************************************/
void minlpsetalgodss(const minlpstate &state, const long double eps, const xparams _xparams = alglib::xdefault);
...
>
  ...
  -- ALGLIB --
     Copyright 08.11.2020 by Bochkanov Sergey
*************************************************************************/
void minlpsetalgoipm(const minlpstate &state, const long double eps, const xparams _xparams = alglib::xdefault);
...
NOTE: BndL>BndU will result in LP problem being recognized as infeasible.
  ...
  -- ALGLIB --
     Copyright 19.07.2018 by Bochkanov Sergey
*************************************************************************/
void minlpsetbcall(const minlpstate &state, const long double bndl, const long double bndu, const xparams _xparams = alglib::xdefault);
...
NOTE: BndL>BndU will result in LP problem being recognized as infeasible.
  ...
  -- ALGLIB --
     Copyright 19.07.2018 by Bochkanov Sergey
*************************************************************************/
void minlpsetbci(const minlpstate &state, const ae_int_t i, const long double bndl, const long double bndu, const xparams _xparams = alglib::xdefault);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 19.07.2018 by Bochkanov Sergey
*************************************************************************/
void minlpaddlc2dense(const minlpstate &state, const real_1d_array &a, const long double al, const long double au, const xparams _xparams = alglib::xdefault);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 19.07.2018 by Bochkanov Sergey
*************************************************************************/
void minlpaddlc2(const minlpstate &state, const integer_1d_array &idxa, const real_1d_array &vala, const ae_int_t nnz, const long double al, const long double au, const xparams _xparams = alglib::xdefault);
...
4. Numerical  differentiation  is   very   inefficient  -   one   gradient
  ...
  -- ALGLIB --
     Copyright 06.06.2014 by Bochkanov Sergey
*************************************************************************/
void minnlccreatef(const ae_int_t n, const real_1d_array &x, const long double diffstep, minnlcstate &state, const xparams _xparams = alglib::xdefault);
void minnlccreatef(const real_1d_array &x, const long double diffstep, minnlcstate &state, const xparams _xparams = alglib::xdefault);
...
selection of the stopping condition.
  ...
  -- ALGLIB --
     Copyright 06.06.2014 by Bochkanov Sergey
*************************************************************************/
void minnlcsetcond(const minnlcstate &state, const long double epsx, const ae_int_t maxits, const xparams _xparams = alglib::xdefault);
...
NOTE: different solvers employed by MinNLC optimizer use  different  norms
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
void minnlcsetstpmax(const minnlcstate &state, const long double stpmax, const xparams _xparams = alglib::xdefault);
...
destabilize algorithm.
  ...
  -- ALGLIB --
     Copyright 06.06.2014 by Bochkanov Sergey
*************************************************************************/
void minnlcsetalgoaul(const minnlcstate &state, const long double rho, const ae_int_t itscnt, const xparams _xparams = alglib::xdefault);
...
In order to verify gradient algorithm performs following steps:
  ...
  * we  build  cubic  model using function values and derivatives at trial
  ...
  -- ALGLIB --
     Copyright 15.06.2014 by Bochkanov Sergey
*************************************************************************/
void minnlcoptguardgradient(const minnlcstate &state, const long double teststep, const xparams _xparams = alglib::xdefault);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 18.05.2015 by Bochkanov Sergey
*************************************************************************/
void minnscreatef(const ae_int_t n, const real_1d_array &x, const long double diffstep, minnsstate &state, const xparams _xparams = alglib::xdefault);
void minnscreatef(const real_1d_array &x, const long double diffstep, minnsstate &state, const xparams _xparams = alglib::xdefault);
...
choice in production code.
  ...
  -- ALGLIB --
     Copyright 18.05.2015 by Bochkanov Sergey
*************************************************************************/
void minnssetcond(const minnsstate &state, const long double epsx, const ae_int_t maxits, const xparams _xparams = alglib::xdefault);
...
>
  ...
  -- ALGLIB --
     Copyright 18.05.2015 by Bochkanov Sergey
*************************************************************************/
void minnssetalgoags(const minnsstate &state, const long double radius, const long double penalty, const xparams _xparams = alglib::xdefault);
...
optimizer. It does nothing in the current version of BLEIC.
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
void minbleicsetbarrierwidth(const minbleicstate &state, const long double mu, const xparams _xparams = alglib::xdefault);
...
optimizer. It does nothing in the current version of BLEIC.
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
void minbleicsetbarrierdecay(const minbleicstate &state, const long double mudecay, const xparams _xparams = alglib::xdefault);
...
Was replaced by MinBLEIC subpackage.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
void minasasetcond(const minasastate &state, const long double epsg, const long double epsf, const long double epsx, const ae_int_t maxits, const xparams _xparams = alglib::xdefault);
...
Was replaced by MinBLEIC subpackage.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
void minasasetstpmax(const minasastate &state, const long double stpmax, const xparams _xparams = alglib::xdefault);
...
4. Numerical  differentiation  is   very   inefficient  -   one   gradient
  ...
  -- ALGLIB --
     Copyright 16.05.2011 by Bochkanov Sergey
*************************************************************************/
void minbccreatef(const ae_int_t n, const real_1d_array &x, const long double diffstep, minbcstate &state, const xparams _xparams = alglib::xdefault);
void minbccreatef(const real_1d_array &x, const long double diffstep, minbcstate &state, const xparams _xparams = alglib::xdefault);
...
NOTE: when SetCond() called with non-zero MaxIts, BC solver may perform
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
void minbcsetcond(const minbcstate &state, const long double epsg, const long double epsf, const long double epsx, const ae_int_t maxits, const xparams _xparams = alglib::xdefault);
...
overflow) without actually calculating function value at the x+stp*d.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
void minbcsetstpmax(const minbcstate &state, const long double stpmax, const xparams _xparams = alglib::xdefault);
...
In order to verify gradient algorithm performs following steps:
  ...
  * we  build  cubic  model using function values and derivatives at trial
  ...
  -- ALGLIB --
     Copyright 15.06.2014 by Bochkanov Sergey
*************************************************************************/
void minbcoptguardgradient(const minbcstate &state, const long double teststep, const xparams _xparams = alglib::xdefault);
...
*************************************************************************/
void lptestproblemcreate(const ae_int_t n, const bool hasknowntarget, const long double targetf, lptestproblem &p, const xparams _xparams = alglib::xdefault);
...
This function is intended for internal use by ALGLIB.
  ...
  -- ALGLIB --
     Copyright 20.07.2021 by Bochkanov Sergey
*************************************************************************/
long double lptestproblemgettargetf(const lptestproblem &p, const xparams _xparams = alglib::xdefault);
...
void unscaleandchecknlcviolation(/* Real    */ ae_vector* fi,
     ...
     ae_int_t* nlcidx,
     ae_state *_state);
void trimprepare(long double f, long double* threshold, ae_state *_state);
void trimfunction(long double* f,
     /* Real    */ ae_vector* g,
     ae_int_t n,
...
void calculatestepbound(/* Real    */ ae_vector* x,
     ...
     long double* valuetofreeze,
     long double* maxsteplen,
     ae_state *_state);
...
ae_bool findfeasiblepoint(/* Real    */ ae_vector* x,
     ...
     ae_int_t* gpaits,
     ae_state *_state);
ae_bool derivativecheck(long double f0,
     long double df0,
     long double f1,
     long double df1,
     long double f,
     ...
     long double width,
     ae_state *_state);
void estimateparabolicmodel(long double absasum,
     long double absasum2,
     long double mx,
     long double mb,
     long double md,
...
void cqmsetactiveset(convexquadraticmodel* s,
     ...
     ae_state *_state);
long double cqmeval(convexquadraticmodel* s,
     /* Real    */ ae_vector* x,
     ae_state *_state);
...
void cqmgradunconstrained(convexquadraticmodel* s,
     ...
     /* Real    */ ae_vector* g,
     ae_state *_state);
long double cqmxtadx2(convexquadraticmodel* s,
     /* Real    */ ae_vector* x,
     /* Real    */ ae_vector* tmp,
     ae_state *_state);
...
void cqmgetdiaga(convexquadraticmodel* s,
     /* Real    */ ae_vector* x,
     ae_state *_state);
long double cqmdebugconstrainedevalt(convexquadraticmodel* s,
     /* Real    */ ae_vector* x,
     ae_state *_state);
long double cqmdebugconstrainedevale(convexquadraticmodel* s,
     /* Real    */ ae_vector* x,
     ae_state *_state);
...
void normalizemixedbrlcinplace(sparsematrix* sparsea,
     ...
     ae_bool neednorms,
     ae_state *_state);
long double normalizedenseqpinplace(/* Real    */ ae_matrix* densea,
     ae_bool isupper,
     ae_int_t nmain,
     /* Real    */ ae_vector* denseb,
     ae_int_t ntotal,
     ae_state *_state);
long double normalizesparseqpinplace(sparsematrix* sparsea,
     ae_bool isupper,
     /* Real    */ ae_matrix* densecorrc,
     /* Real    */ ae_vector* densecorrd,
     ae_int_t corrrank,
...
void sascorrection(sactiveset* state,
     ...
     long double* penalty,
     ae_state *_state);
long double sasactivelcpenalty1(sactiveset* state,
     /* Real    */ ae_vector* x,
     ae_state *_state);
long double sasscaledconstrainednorm(sactiveset* state,
     /* Real    */ ae_vector* d,
     ae_state *_state);
...
void minqpsetalgodenseaul(minqpstate* state,
     ...
     ae_int_t itscnt,
     ae_state *_state);
void minqpsetalgodenseipm(minqpstate* state, long double eps, ae_state *_state);
...
void minlmsetstpmax(minlmstate* state, long double stpmax, ae_state *_state);
...
void mincgsetstpmax(mincgstate* state, long double stpmax, ae_state *_state);
void mincgsuggeststep(mincgstate* state, long double stp, ae_state *_state);
long double mincglastgoodstep(mincgstate* state, ae_state *_state);
...
void minlpsetalgodss(minlpstate* state, long double eps, ae_state *_state);
void minlpsetalgoipm(minlpstate* state, long double eps, ae_state *_state);
...
void minnlcsetstpmax(minnlcstate* state, long double stpmax, ae_state *_state);
...
void minnlcrestartfrom(minnlcstate* state,
     /* Real    */ ae_vector* x,
     ae_state *_state);
void minnlcequalitypenaltyfunction(long double alpha,
     long double* f,
     long double* df,
     long double* d2f,
     ae_state *_state);
void minnlcinequalitypenaltyfunction(long double alpha,
     long double stabilizingpoint,
     long double* f,
     long double* df,
     long double* d2f,
     ae_state *_state);
void minnlcinequalityshiftfunction(long double alpha,
     long double* f,
     long double* df,
     long double* d2f,
     ae_state *_state);
...
void minasasetalgorithm(minasastate* state,
     ae_int_t algotype,
     ae_state *_state);
void minasasetstpmax(minasastate* state, long double stpmax, ae_state *_state);
...
void minbcsetstpmax(minbcstate* state, long double stpmax, ae_state *_state);
...
long double lptestproblemgettargetf(lptestproblem* p, ae_state *_state);
