...
typedef struct
{
    ...
    ae_vector omegaip1;
    long double alphai;
    long double alphaip1;
    long double betai;
    long double betaip1;
    long double phibari;
    long double phibarip1;
    long double phii;
    long double rhobari;
    long double rhobarip1;
    long double rhoi;
    long double ci;
    long double si;
    long double theta;
...
*************************************************************************/
void rmatrixsolvels(const real_2d_array &a, const ae_int_t nrows, const ae_int_t ncols, const real_1d_array &b, const long double threshold, ae_int_t &info, densesolverlsreport &rep, real_1d_array &x, const xparams _xparams = alglib::xdefault);
#endif
...
*************************************************************************/
void sparsesolvesymmetricgmres(const sparsematrix &a, const bool isupper, const real_1d_array &b, const ae_int_t k, const long double epsf, const ae_int_t maxits, real_1d_array &x, sparsesolverreport &rep, const xparams _xparams = alglib::xdefault);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 25.09.2021 by Bochkanov Sergey
*************************************************************************/
void sparsesolvegmres(const sparsematrix &a, const real_1d_array &b, const ae_int_t k, const long double epsf, const ae_int_t maxits, real_1d_array &x, sparsesolverreport &rep, const xparams _xparams = alglib::xdefault);
...
*************************************************************************/
void sparsesolversetcond(const sparsesolverstate &state, const long double epsf, const ae_int_t maxits, const xparams _xparams = alglib::xdefault);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 24.09.2021 by Bochkanov Sergey
*************************************************************************/
void sparsesolveroocgetrequestdata1(const sparsesolverstate &state, long double &v, const xparams _xparams = alglib::xdefault);
...
value.
  ...
  -- ALGLIB --
     Copyright 14.11.2011 by Bochkanov Sergey
*************************************************************************/
void lincgsetcond(const lincgstate &state, const long double epsf, const ae_int_t maxits, const xparams _xparams = alglib::xdefault);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 30.11.2011 by Bochkanov Sergey
*************************************************************************/
void linlsqrsetlambdai(const linlsqrstate &state, const long double lambdai, const xparams _xparams = alglib::xdefault);
...
be setted as default values.
  ...
  -- ALGLIB --
     Copyright 30.11.2011 by Bochkanov Sergey
*************************************************************************/
void linlsqrsetcond(const linlsqrstate &state, const long double epsa, const long double epsb, const ae_int_t maxits, const xparams _xparams = alglib::xdefault);
...
*************************************************************************/
void nleqsetcond(const nleqstate &state, const long double epsf, const ae_int_t maxits, const xparams _xparams = alglib::xdefault);
...
function value at the x+stp*d.
  ...
  -- ALGLIB --
     Copyright 20.08.2010 by Bochkanov Sergey
*************************************************************************/
void nleqsetstpmax(const nleqstate &state, const long double stpmax, const xparams _xparams = alglib::xdefault);
