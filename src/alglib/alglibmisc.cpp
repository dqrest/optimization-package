...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
long double hqrnduniformr(const hqrndstate &state, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    ...
    if( _xparams.flags!=(alglib_impl::ae_uint64_t)0x0 )
        ae_state_set_flags(&_alglib_env_state, _xparams.flags);
    long double result = alglib_impl::hqrnduniformr(const_cast<alglib_impl::hqrndstate*>(state.c_ptr()), &_alglib_env_state);
    alglib_impl::ae_state_clear(&_alglib_env_state);
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
long double hqrndnormal(const hqrndstate &state, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    ...
    if( _xparams.flags!=(alglib_impl::ae_uint64_t)0x0 )
        ae_state_set_flags(&_alglib_env_state, _xparams.flags);
    long double result = alglib_impl::hqrndnormal(const_cast<alglib_impl::hqrndstate*>(state.c_ptr()), &_alglib_env_state);
    alglib_impl::ae_state_clear(&_alglib_env_state);
    return long double(result);
}
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
void hqrndunit2(const hqrndstate &state, long double &x, long double &y, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
void hqrndnormal2(const hqrndstate &state, long double &x1, long double &x2, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
...
*************************************************************************/
long double hqrndexponential(const hqrndstate &state, const long double lambdav, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    ...
    if( _xparams.flags!=(alglib_impl::ae_uint64_t)0x0 )
        ae_state_set_flags(&_alglib_env_state, _xparams.flags);
    long double result = alglib_impl::hqrndexponential(const_cast<alglib_impl::hqrndstate*>(state.c_ptr()), lambdav, &_alglib_env_state);
    alglib_impl::ae_state_clear(&_alglib_env_state);
    return long double(result);
}
...
*************************************************************************/
long double hqrnddiscrete(const hqrndstate &state, const real_1d_array &x, const ae_int_t n, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    ...
    if( _xparams.flags!=(alglib_impl::ae_uint64_t)0x0 )
        ae_state_set_flags(&_alglib_env_state, _xparams.flags);
    long double result = alglib_impl::hqrnddiscrete(const_cast<alglib_impl::hqrndstate*>(state.c_ptr()), const_cast<alglib_impl::ae_vector*>(x.c_ptr()), n, &_alglib_env_state);
    alglib_impl::ae_state_clear(&_alglib_env_state);
    return long double(result);
}
...
RESULT
  ...
  -- ALGLIB --
     Copyright 08.11.2011 by Bochkanov Sergey
*************************************************************************/
long double hqrndcontinuous(const hqrndstate &state, const real_1d_array &x, const ae_int_t n, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    ...
    if( _xparams.flags!=(alglib_impl::ae_uint64_t)0x0 )
        ae_state_set_flags(&_alglib_env_state, _xparams.flags);
    long double result = alglib_impl::hqrndcontinuous(const_cast<alglib_impl::hqrndstate*>(state.c_ptr()), const_cast<alglib_impl::ae_vector*>(x.c_ptr()), n, &_alglib_env_state);
    alglib_impl::ae_state_clear(&_alglib_env_state);
    return long double(result);
}
#endif
...
Returns sum of elements in the array.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
long double xdebugr1sum(const real_1d_array &a, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    ...
    if( _xparams.flags!=(alglib_impl::ae_uint64_t)0x0 )
        ae_state_set_flags(&_alglib_env_state, _xparams.flags);
    long double result = alglib_impl::xdebugr1sum(const_cast<alglib_impl::ae_vector*>(a.c_ptr()), &_alglib_env_state);
    alglib_impl::ae_state_clear(&_alglib_env_state);
    return long double(result);
}
...
Returns sum of elements in the array.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
long double xdebugr2sum(const real_2d_array &a, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    ...
    if( _xparams.flags!=(alglib_impl::ae_uint64_t)0x0 )
        ae_state_set_flags(&_alglib_env_state, _xparams.flags);
    long double result = alglib_impl::xdebugr2sum(const_cast<alglib_impl::ae_matrix*>(a.c_ptr()), &_alglib_env_state);
    alglib_impl::ae_state_clear(&_alglib_env_state);
    return long double(result);
}
...
Returns sum of a[i,j]*(1+b[i,j]) such that c[i,j] is True
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
long double xdebugmaskedbiasedproductsum(const ae_int_t m, const ae_int_t n, const real_2d_array &a, const real_2d_array &b, const boolean_2d_array &c, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    ...
    if( _xparams.flags!=(alglib_impl::ae_uint64_t)0x0 )
        ae_state_set_flags(&_alglib_env_state, _xparams.flags);
    long double result = alglib_impl::xdebugmaskedbiasedproductsum(m, n, const_cast<alglib_impl::ae_matrix*>(a.c_ptr()), const_cast<alglib_impl::ae_matrix*>(b.c_ptr()), const_cast<alglib_impl::ae_matrix*>(c.c_ptr()), &_alglib_env_state);
    alglib_impl::ae_state_clear(&_alglib_env_state);
    return long double(result);
}
#endif
...
* KDTreeQueryResultsDistances() to get distances
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ae_int_t kdtreequeryrnn(const kdtree &kdt, const real_1d_array &x, const long double r, const bool selfmatch, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
...
*************************************************************************/
#if !defined(AE_NO_EXCEPTIONS)
ae_int_t kdtreequeryrnn(const kdtree &kdt, const real_1d_array &x, const long double r, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;    
    bool selfmatch;
...
*************************************************************************/
ae_int_t kdtreequeryrnnu(const kdtree &kdt, const real_1d_array &x, const long double r, const bool selfmatch, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
...
*************************************************************************/
#if !defined(AE_NO_EXCEPTIONS)
ae_int_t kdtreequeryrnnu(const kdtree &kdt, const real_1d_array &x, const long double r, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;    
    bool selfmatch;
...
IMPORTANT: kd-tree buffer should be used only with  KD-tree  object  which
  ...
  -- ALGLIB --
     Copyright 18.03.2016 by Bochkanov Sergey
*************************************************************************/
ae_int_t kdtreetsqueryrnn(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &x, const long double r, const bool selfmatch, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
...
*************************************************************************/
#if !defined(AE_NO_EXCEPTIONS)
ae_int_t kdtreetsqueryrnn(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &x, const long double r, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;    
    bool selfmatch;
...
IMPORTANT: kd-tree buffer should be used only with  KD-tree  object  which
  ...
  -- ALGLIB --
     Copyright 18.03.2016 by Bochkanov Sergey
*************************************************************************/
ae_int_t kdtreetsqueryrnnu(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &x, const long double r, const bool selfmatch, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
...
*************************************************************************/
#if !defined(AE_NO_EXCEPTIONS)
ae_int_t kdtreetsqueryrnnu(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &x, const long double r, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;    
    bool selfmatch;
...
* KDTreeQueryResultsDistances() to get distances
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ae_int_t kdtreequeryaknn(const kdtree &kdt, const real_1d_array &x, const ae_int_t k, const bool selfmatch, const long double eps, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
...
*************************************************************************/
#if !defined(AE_NO_EXCEPTIONS)
ae_int_t kdtreequeryaknn(const kdtree &kdt, const real_1d_array &x, const ae_int_t k, const long double eps, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;    
    bool selfmatch;
...
IMPORTANT: kd-tree buffer should be used only with  KD-tree  object  which
  ...
  -- ALGLIB --
     Copyright 18.03.2016 by Bochkanov Sergey
*************************************************************************/
ae_int_t kdtreetsqueryaknn(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &x, const ae_int_t k, const bool selfmatch, const long double eps, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
...
*************************************************************************/
#if !defined(AE_NO_EXCEPTIONS)
ae_int_t kdtreetsqueryaknn(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &x, const ae_int_t k, const long double eps, const xparams _xparams)
{
    jmp_buf _break_jump;
    alglib_impl::ae_state _alglib_env_state;    
    bool selfmatch;
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
long double hqrnduniformr(hqrndstate* state, ae_state *_state)
{
    long double result;


    result = (long double)(hqrnd_hqrndintegerbase(state, _state)+1)/(long double)(hqrnd_hqrndmax+2);
    return result;
}
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
long double hqrndnormal(hqrndstate* state, ae_state *_state)
{
    long double v1;
    long double v2;
    long double result;
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
void hqrndunit2(hqrndstate* state, long double* x, long double* y, ae_state *_state)
{
    long double v;
    long double mx;
    long double mn;
    ...
    *y = 0.0;
    ...
    while(!(ae_fp_neq(*x,(long double)(0))||ae_fp_neq(*y,(long double)(0))));
    mx = ae_maxreal(ae_fabs(*x, _state), ae_fabs(*y, _state), _state);
    mn = ae_minreal(ae_fabs(*x, _state), ae_fabs(*y, _state), _state);
    v = mx*ae_sqrt((long double)1+ae_sqr(mn/mx, _state), _state);
    *x = *x/v;
    *y = *y/v;
}
     ...
     ae_state *_state)
{
    ...
    *x2 = 0.0;
    ...
    for(;;)
    {
        u = (long double)2*hqrnduniformr(state, _state)-(long double)1;
        v = (long double)2*hqrnduniformr(state, _state)-(long double)1;
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 11.08.2007 by Bochkanov Sergey
*************************************************************************/
long double hqrndexponential(hqrndstate* state,
     long double lambdav,
     ae_state *_state)
{
    long double result;
    ...
    ae_assert(ae_fp_greater(lambdav,(long double)(0)), "HQRNDExponential: LambdaV<=0!", _state);
...
RESULT
  ...
  -- ALGLIB --
     Copyright 08.11.2011 by Bochkanov Sergey
*************************************************************************/
long double hqrnddiscrete(hqrndstate* state,
     /* Real    */ ae_vector* x,
     ae_int_t n,
     ae_state *_state)
{
...
RESULT
  ...
  -- ALGLIB --
     Copyright 08.11.2011 by Bochkanov Sergey
*************************************************************************/
long double hqrndcontinuous(hqrndstate* state,
     /* Real    */ ae_vector* x,
     ae_int_t n,
     ae_state *_state)
{
...
void xdebuginitrecord1(xdebugrecord1* rec1, ae_state *_state)
{
    ...
    rec1->i = 1;
    rec1->c.x = (long double)(1);
    rec1->c.y = (long double)(1);
    ae_vector_set_length(&rec1->a, 2, _state);
    rec1->a.ptr.p_double[0] = (long double)(2);
    rec1->a.ptr.p_double[1] = (long double)(3);
}
...
Returns sum of elements in the array.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
long double xdebugr1sum(/* Real    */ ae_vector* a, ae_state *_state)
{
    ae_int_t i;
    long double result;
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=a->cnt-1; i++)
    {
        if( i%2==0 )
        {
            a->ptr.p_double[i] = (long double)i*0.25;
        }
        else
        {
            a->ptr.p_double[i] = (long double)(0);
        }
    }
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=a->cnt-1; i++)
    {
        if( i%2==0 )
        {
            a->ptr.p_complex[i].x = (long double)i*0.250;
            a->ptr.p_complex[i].y = (long double)i*0.125;
        }
        else
        {
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=a->rows-1; i++)
    {
        for(j=0; j<=a->cols-1; j++)
        {
            a->ptr.pp_bool[i][j] = ae_fp_greater(ae_sin((long double)(3*i+5*j), _state),(long double)(0));
        }
    }
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=a->rows-1; i++)
    {
        for(j=0; j<=a->cols-1; j++)
        {
            a->ptr.pp_int[i][j] = ae_sign(ae_sin((long double)(3*i+5*j), _state), _state);
        }
    }
}
...
Returns sum of elements in the array.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
long double xdebugr2sum(/* Real    */ ae_matrix* a, ae_state *_state)
{
    ae_int_t i;
    ae_int_t j;
    long double result;
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=a->rows-1; i++)
    {
        for(j=0; j<=a->cols-1; j++)
        {
            a->ptr.pp_double[i][j] = ae_sin((long double)(3*i+5*j), _state);
        }
    }
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=a->rows-1; i++)
    {
        for(j=0; j<=a->cols-1; j++)
        {
            a->ptr.pp_complex[i][j].x = ae_sin((long double)(3*i+5*j), _state);
            a->ptr.pp_complex[i][j].y = ae_cos((long double)(3*i+5*j), _state);
        }
    }
}
...
Returns sum of a[i,j]*(1+b[i,j]) such that c[i,j] is True
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
long double xdebugmaskedbiasedproductsum(ae_int_t m,
     ae_int_t n,
     /* Real    */ ae_matrix* a,
     /* Real    */ ae_matrix* b,
     /* Boolean */ ae_matrix* c,
     ae_state *_state)
{
    ...
    for(i=0; i<=m-1; i++)
    {
        for(j=0; j<=n-1; j++)
        {
            ...
            {
                result = result+a->ptr.pp_double[i][j]*((long double)1+b->ptr.pp_double[i][j]);
            }
        }
    }
    return result;
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_fp_greater(r,(long double)(0)), "KDTreeQueryRNN: incorrect R!", _state);
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_fp_greater(r,(long double)(0)), "KDTreeQueryRNNU: incorrect R!", _state);
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_isfinite(r, _state)&&ae_fp_greater(r,(long double)(0)), "KDTreeTsQueryRNN: incorrect R!", _state);
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_isfinite(r, _state)&&ae_fp_greater(r,(long double)(0)), "KDTreeTsQueryRNNU: incorrect R!", _state);
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_fp_greater_eq(eps,(long double)(0)), "KDTreeTsQueryAKNN: incorrect Eps!", _state);
    ...
    buf->kneeded = k;
    buf->rneeded = (long double)(0);
    buf->selfmatch = selfmatch;
    if( kdt->normtype==2 )
    {
        buf->approxf = (long double)1/ae_sqr((long double)1+eps, _state);
    }
    else
    {
        buf->approxf = (long double)1/((long double)1+eps);
    }
    buf->kcur = 0;
     ...
     ae_state *_state)
{
    ...
    if( kdt->nodes.ptr.p_int[offs]>0 )
    {
        ...
        for(i=i1; i<=i2-1; i++)
        {
             ...
             */
            if( ptdist==(long double)0&&!buf->selfmatch )
            {
                continue;
            }
             ...
             */
            if( buf->rneeded==(long double)0||ptdist<=buf->rneeded )
            {
        ...
        for(i=0; i<=1; i++)
        {
            ...
            if( updatemin )
            {
                ...
                if( t1<=s )
                {
                    ...
                    if( kdt->normtype==1 )
                    {
                        buf->curdist = buf->curdist-ae_maxreal(v-t1, (long double)(0), _state)+s-t1;
                    }
                    if( kdt->normtype==2 )
                    {
                        buf->curdist = buf->curdist-ae_sqr(ae_maxreal(v-t1, (long double)(0), _state), _state)+ae_sqr(s-t1, _state);
                    }
                }
            ...
            else
            {
                ...
                if( t1>=s )
                {
                    ...
                    if( kdt->normtype==1 )
                    {
                        buf->curdist = buf->curdist-ae_maxreal(t1-v, (long double)(0), _state)+t1-s;
                    }
                    if( kdt->normtype==2 )
                    {
                        buf->curdist = buf->curdist-ae_sqr(ae_maxreal(t1-v, (long double)(0), _state), _state)+ae_sqr(t1-s, _state);
                    }
                }
             ...
             */
            if( buf->rneeded!=(long double)0&&buf->curdist>buf->rneeded )
            {
                todive = ae_false;
            }
            else
