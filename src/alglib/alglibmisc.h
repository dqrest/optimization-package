...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
long double hqrnduniformr(const hqrndstate &state, const xparams _xparams = alglib::xdefault);
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
long double hqrndnormal(const hqrndstate &state, const xparams _xparams = alglib::xdefault);
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
void hqrndunit2(const hqrndstate &state, long double &x, long double &y, const xparams _xparams = alglib::xdefault);
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
void hqrndnormal2(const hqrndstate &state, long double &x1, long double &x2, const xparams _xparams = alglib::xdefault);
...
*************************************************************************/
long double hqrndexponential(const hqrndstate &state, const long double lambdav, const xparams _xparams = alglib::xdefault);
...
*************************************************************************/
long double hqrnddiscrete(const hqrndstate &state, const real_1d_array &x, const ae_int_t n, const xparams _xparams = alglib::xdefault);
...
RESULT
  ...
  -- ALGLIB --
     Copyright 08.11.2011 by Bochkanov Sergey
*************************************************************************/
long double hqrndcontinuous(const hqrndstate &state, const real_1d_array &x, const ae_int_t n, const xparams _xparams = alglib::xdefault);
#endif
...
Returns sum of elements in the array.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
long double xdebugr1sum(const real_1d_array &a, const xparams _xparams = alglib::xdefault);
...
Returns sum of elements in the array.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
long double xdebugr2sum(const real_2d_array &a, const xparams _xparams = alglib::xdefault);
...
Returns sum of a[i,j]*(1+b[i,j]) such that c[i,j] is True
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
long double xdebugmaskedbiasedproductsum(const ae_int_t m, const ae_int_t n, const real_2d_array &a, const real_2d_array &b, const boolean_2d_array &c, const xparams _xparams = alglib::xdefault);
#endif
...
* KDTreeQueryResultsDistances() to get distances
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ae_int_t kdtreequeryrnn(const kdtree &kdt, const real_1d_array &x, const long double r, const bool selfmatch, const xparams _xparams = alglib::xdefault);
ae_int_t kdtreequeryrnn(const kdtree &kdt, const real_1d_array &x, const long double r, const xparams _xparams = alglib::xdefault);
...
*************************************************************************/
ae_int_t kdtreequeryrnnu(const kdtree &kdt, const real_1d_array &x, const long double r, const bool selfmatch, const xparams _xparams = alglib::xdefault);
ae_int_t kdtreequeryrnnu(const kdtree &kdt, const real_1d_array &x, const long double r, const xparams _xparams = alglib::xdefault);
...
IMPORTANT: kd-tree buffer should be used only with  KD-tree  object  which
  ...
  -- ALGLIB --
     Copyright 18.03.2016 by Bochkanov Sergey
*************************************************************************/
ae_int_t kdtreetsqueryrnn(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &x, const long double r, const bool selfmatch, const xparams _xparams = alglib::xdefault);
ae_int_t kdtreetsqueryrnn(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &x, const long double r, const xparams _xparams = alglib::xdefault);
...
IMPORTANT: kd-tree buffer should be used only with  KD-tree  object  which
  ...
  -- ALGLIB --
     Copyright 18.03.2016 by Bochkanov Sergey
*************************************************************************/
ae_int_t kdtreetsqueryrnnu(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &x, const long double r, const bool selfmatch, const xparams _xparams = alglib::xdefault);
ae_int_t kdtreetsqueryrnnu(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &x, const long double r, const xparams _xparams = alglib::xdefault);
...
* KDTreeQueryResultsDistances() to get distances
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ae_int_t kdtreequeryaknn(const kdtree &kdt, const real_1d_array &x, const ae_int_t k, const bool selfmatch, const long double eps, const xparams _xparams = alglib::xdefault);
ae_int_t kdtreequeryaknn(const kdtree &kdt, const real_1d_array &x, const ae_int_t k, const long double eps, const xparams _xparams = alglib::xdefault);
...
IMPORTANT: kd-tree buffer should be used only with  KD-tree  object  which
  ...
  -- ALGLIB --
     Copyright 18.03.2016 by Bochkanov Sergey
*************************************************************************/
ae_int_t kdtreetsqueryaknn(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &x, const ae_int_t k, const bool selfmatch, const long double eps, const xparams _xparams = alglib::xdefault);
ae_int_t kdtreetsqueryaknn(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &x, const ae_int_t k, const long double eps, const xparams _xparams = alglib::xdefault);
